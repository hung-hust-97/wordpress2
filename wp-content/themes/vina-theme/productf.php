<?php
// [blog_posts]
function shortcode_latest_from_blog1($atts, $content = null, $tag) {
...
while ( $recentPosts->have_posts() ) : $recentPosts->the_post();
		...
		<div class="col <?php echo implode(' ', $col_class); ?>" <?php echo $animate;?>>
			<div class="col-inner product-item">
          ...
          <?php } ?>
					...
					<div class="box-text" <?php echo get_shortcode_inline_css($css_args); ?>>

					<div class="box-text-inner blog-post-inner">

					<?php do_action('flatsome_blog_post_before'); ?>

					<h5 class="post-title rsb is-<?php echo $title_size; ?> <?php echo $title_style;?>"><?php the_title(); ?></h5>
					...
					<?php
						foreach((get_the_location()) as $cat) {
						echo $cat->cat_name . ' ';
					}
					?>
					</p>
...
add_shortcode("blog_posts1", "shortcode_latest_from_blog1");
