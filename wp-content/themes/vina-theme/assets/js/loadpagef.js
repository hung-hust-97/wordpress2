...
try {
    ...
    function atvImg() {
        function t(t, e, i, n, r, a) {
            var l = o.scrollTop || s.scrollTop,
                ...
                b = Math.atan2(y, _),
                S = 180 * b / Math.PI - 90;
            0 > S && (S += 360), -1 != i.firstChild.className.indexOf(" over") && (T += " scale3d(1.05,1.05,1.05)"), i.firstChild.style.transform = T, a.style.background = "linear-gradient(" + S + "deg, rgba(0,0,0," + (h - f.top - l) / d * .4 + ") 0%,rgba(0,0,0,0) 100%)", a.style.transform = "translateX(" + g * r - .1 + "px) translateY(" + v * r - .1 + "px)";
            for (var C = r, k = 0; r > k; k++) n[k].style.transform = "translateX(" + g * C * (2.5 * k / m) + "px) translateY(" + v * r * (2.5 * k / m) + "px)", C--
        }
        ...
        function i(t, e, i, n, r) {
            var o = e.firstChild;
            o.className = o.className.replace(" over", ""), o.style.transform = "", r.style.cssText = "";
            for (var s = 0; n > s; s++) i[s].style.transform = ""
        }
        var n = document,
            r = n.documentElement,
            ...
            for (var h = 0; u > h; h++) {
                ...
                if (!(0 >= d)) {
                    ...
                    var m = n.createElement("div"),
                        ...
                        _ = [];
                    f.id = "atvImg__" + h, m.className = "atvImg-container", g.className = "atvImg-shine", v.className = "atvImg-shadow", y.className = "atvImg-layers";
                    for (var x = 0; d > x; x++) {
                        var w = n.createElement("div"),
                            T = p[x].getAttribute("data-img");
                        w.className = "atvImg-rendered-layer", w.setAttribute("data-layer", x), w.style.backgroundImage = "url(" + T + ")", y.appendChild(w), _.push(w)
                    }
                    m.appendChild(v), m.appendChild(y), m.appendChild(g), f.appendChild(m);
                    var b = f.clientWidth || f.offsetWidth || f.scrollWidth;
                    f.style.transform = "perspective(" + 3 * b + "px)", c ? (a.preventScroll = !1, function(n, r, o, s) {
                        f.addEventListener("touchmove", function(e) {
                            a.preventScroll && e.preventDefault(), t(e, !0, n, r, o, s)
                        }), f.addEventListener("touchstart", function(t) {
                            a.preventScroll = !0, e(t, n)
                        }), f.addEventListener("touchend", function(t) {
                            a.preventScroll = !1, i(t, n, r, o, s)
                        })
    ...
    function escapeRegExp(t) {
        ...
        function r(t, e, i) {
            ...
            }) : St.test(e) ? dt.filter(e, t, i) : (e = dt.filter(e, t), dt.grep(t, function(t) {
        ...
        function p(t, e, i, n) {
            ...
            if (c && c[3] !== u) {
                u = u || c[3], i = i || [], c = +l || 1;
                do o = o || ".5", c /= o, dt.style(t, e, c + u); while (o !== (o = a() / l) && 1 !== o && --s)
            }
        ...
        function d(t) {
            var e, i = t.ownerDocument,
                n = t.nodeName,
                r = Ht[n];
            return r ? r : (e = i.body.appendChild(i.createElement(n)), r = dt.css(e, "display"), e.parentNode.removeChild(e), "none" === r && (r = "block"), Ht[n] = r, r)
        }

        function m(t, e) {
            for (var i, n, r = [], o = 0, s = t.length; o < s; o++) n = t[o], n.style && (i = n.style.display, e ? ("none" === i && (r[o] = Rt.get(n, "display") || null, r[o] || (n.style.display = "")), "" === n.style.display && Wt(n) && (r[o] = d(n))) : "none" !== i && (r[o] = "none", Rt.set(n, "display", i)));
        ...
        function g(t, e) {
            var i;
            return i = "undefined" != typeof t.getElementsByTagName ? t.getElementsByTagName(e || "*") : "undefined" != typeof t.querySelectorAll ? t.querySelectorAll(e || "*") : [], void 0 === e || e && dt.nodeName(t, e) ? dt.merge([t], i) : i
        }
        ...
        function y(t, e, i, n, r) {
            for (var o, s, a, l, u, c, h = e.createDocumentFragment(), f = [], p = 0, d = t.length; p < d; p++)
                ...
                for (s = s || h.appendChild(e.createElement("div")), a = (Yt.exec(o) || ["", ""])[1].toLowerCase(), l = Vt[a] || Vt._default, s.innerHTML = l[1] + dt.htmlPrefilter(o) + l[2], c = l[0]; c--;) s = s.lastChild;
                dt.merge(f, s.childNodes), s = h.firstChild, s.textContent = ""
            } else f.push(e.createTextNode(o));
            for (h.textContent = "", p = 0; o = f[p++];)
                if (n && dt.inArray(o, n) > -1) r && r.push(o);
                else if (u = dt.contains(o.ownerDocument, o), s = g(h.appendChild(o), "script"), u && v(s), i)
                for (c = 0; o = s[c++];) Ut.test(o.type || "") && i.push(o);
            return h
        }
        ...
        function k(t, e) {
            var i, n, r, o, s, a, l, u;
            if (1 === e.nodeType) {
                if (Rt.hasData(t) && (o = Rt.access(t), s = Rt.set(e, o), u = o.events)) {
        ...
        function O(t, e, n, r) {
            ...
            var o, s, a, l, u, c, h = 0,
                ...
                d = e[0],
                m = dt.isFunction(d);
            if (m || f > 1 && "string" == typeof d && !ft.checkClone && ie.test(d)) return t.each(function(i) {
                var o = t.eq(i);
                m && (e[0] = d.call(this, i, o.html())), O(o, e, n, r)
            });
            if (f && (o = y(e, t[0].ownerDocument, !1, t, r), s = o.firstChild, 1 === o.childNodes.length && (o = s), s || r)) {
                for (a = dt.map(g(o, "script"), S), l = a.length; h < f; h++) u = o, h !== p && (u = dt.clone(u, !0, !0), l && dt.merge(a, g(u, "script"))), n.call(t[h], u, h);
                if (l)
                    for (c = a[a.length - 1].ownerDocument, dt.map(a, C), h = 0; h < l; h++) u = a[h], Ut.test(u.type || "") && !Rt.access(u, "globalEval") && dt.contains(c, u) && (u.src ? dt._evalUrl && dt._evalUrl(u.src) : i(u.textContent.replace(re, ""), c))
            }
            return t
        }

        function P(t, e, i) {
            for (var n, r = e ? dt.filter(e, t) : t, o = 0; null != (n = r[o]); o++) i || 1 !== n.nodeType || dt.cleanData(g(n)), n.parentNode && (i && dt.contains(n.ownerDocument, n) && v(g(n, "script")), n.parentNode.removeChild(n));
            return t
        }

        function M(t, e, i) {
            var n, r, o, s, a = t.style;
            return i = i || ae(t), i && (s = i.getPropertyValue(e) || i[e], "" !== s || dt.contains(t.ownerDocument, t) || (s = dt.style(t, e)), !ft.pixelMarginRight() && se.test(s) && oe.test(e) && (n = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = i.width, a.width = n, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
        }
        ...
        function I(t, e, i, n, r) {
            var o, s = 0;
            for (o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0; o < 4; o += 2) "margin" === i && (s += dt.css(t, i + $t[o], !0, r)), n ? ("content" === i && (s -= dt.css(t, "padding" + $t[o], !0, r)), "margin" !== i && (s -= dt.css(t, "border" + $t[o] + "Width", !0, r))) : (s += dt.css(t, "padding" + $t[o], !0, r), "padding" !== i && (s += dt.css(t, "border" + $t[o] + "Width", !0, r)));
            return s
        }
        ...
        function R(t, e, i) {
            ...
            if (t.getClientRects().length && (n = t.getBoundingClientRect()[e]), n <= 0 || null == n) {
                if (n = M(t, e, o), (n < 0 || null == n) && (n = t.style[e]), se.test(n)) return n;
                r = s && (ft.boxSizingReliable() || n === t.style[e]), n = parseFloat(n) || 0
            }
        ...
        function F() {
            de && (t.requestAnimationFrame(F), dt.fx.tick())
        }
        ...
        function W(t, e, i) {
            ...
            for (n in e)
                ...
                h && 1 === t.nodeType && (i.overflow = [d.overflow, d.overflowX, d.overflowY], u = v && v.display, null == u && (u = Rt.get(t, "display")), c = dt.css(t, "display"), "none" === c && (u ? c = u : (m([t], !0), u = t.style.display || u, c = dt.css(t, "display"), m([t]))), ("inline" === c || "inline-block" === c && null != u) && "none" === dt.css(t, "float") && (l || (f.done(function() {
                    d.display = u
                }), null == u && (c = d.display, u = "none" === c ? "" : c)), d.display = "inline-block")), i.overflow && (d.overflow = "hidden", f.always(function() {
                    d.overflow = i.overflow[0], d.overflowX = i.overflow[1], d.overflowY = i.overflow[2]
                })), l = !1;
                for (n in p) l || (v ? "hidden" in v && (g = v.hidden) : v = Rt.access(t, "fxshow", {
                    display: u
                }), o && (v.hidden = !g), g && m([t], !0), f.done(function() {
                    g || m([t]), Rt.remove(t, "fxshow");
                    for (n in p) dt.style(t, n, p[n])
                })), l = q(g ? v[n] : 0, n, f), n in v || (v[n] = l.start, g && (l.end = l.start, l.start = 0))
            }
        }
        ...
        function B(t, e) {
            var i, n, r, o, s;
            for (i in t)
                if (n = dt.camelCase(i), r = e[n], o = t[i], dt.isArray(o) && (r = o[1], o = t[i] = o[0]), i !== n && (t[n] = o, delete t[i]), s = dt.cssHooks[n], s && "expand" in s) {
        ...
        function H(t, e, i) {
            var n, r, o = 0,
                ...
                l = function() {
                    if (r) return !1;
                    for (var e = pe || z(), i = Math.max(0, u.startTime + u.duration - e), n = i / u.duration || 0, o = 1 - n, s = 0, l = u.tweens.length; s < l; s++) u.tweens[s].run(o);
            ...
            for (B(c, u.opts.specialEasing); o < s; o++)
                if (n = H.prefilters[o].call(u, t, c, u.opts)) return dt.isFunction(n.stop) && (dt._queueHooks(u.elem, u.opts.queue).stop = dt.proxy(n.stop, n)), n;
        ...
        dt.fn = dt.prototype = {
            ...
            var t, e, i, n, r, o, s = arguments[0] || {},
                ...
                l = arguments.length,
                u = !1;
            for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || dt.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
                if (null != (t = arguments[a]))
                    for (e in t) i = s[e], n = t[e], s !== n && (u && n && (dt.isPlainObject(n) || (r = dt.isArray(n))) ? (r ? (r = !1, o = i && dt.isArray(i) ? i : []) : o = i && dt.isPlainObject(i) ? i : {}, s[e] = dt.extend(u, o, n)) : void 0 !== n && (s[e] = n));
            return s
        }, dt.extend({
            ...
            makeArray: function(t, e) {
                var i = e || [];
                return null != t && (n(Object(t)) ? dt.merge(i, "string" == typeof t ? [t] : t) : ot.call(i, t)), i
            },
        ...
        var _t = function(t) {
            function e(t, e, i, n) {
                ...
                if (!n && ((e ? e.ownerDocument || e : W) !== D && L(e), e = e || D, R)) {
                    if (11 !== d && (l = yt.exec(t)))
                        if (r = l[1]) {
                            if (9 === d) {
                                if (!(s = e.getElementById(r))) return i;
                                if (s.id === r) return i.push(s), i
                            } else if (f && (s = f.getElementById(r)) && j(e, s) && s.id === r) return i.push(s), i
                        } else {
                            if (l[2]) return K.apply(i, e.getElementsByTagName(t)), i;
                            if ((r = l[3]) && T.getElementsByClassName && e.getElementsByClassName) return K.apply(i, e.getElementsByClassName(r)), i
                        } if (T.qsa && !U[t + " "] && (!N || !N.test(t))) {
                        if (1 !== d) f = e, c = t;
                        else if ("object" !== e.nodeName.toLowerCase()) {
                            for ((a = e.getAttribute("id")) ? a = a.replace(wt, Tt) : e.setAttribute("id", a = q), u = k(t), o = u.length; o--;) u[o] = "#" + a + " " + p(u[o]);
                            c = u.join(","), f = $.test(t) && h(e.parentNode) || e
                        }
                        if (c) try {
                            return K.apply(i, f.querySelectorAll(c)), i
                        } catch (t) {} finally {
                        ...
                        for (; e = e[n];)
                            if (1 === e.nodeType || s)
                                if (h = e[q] || (e[q] = {}), c = h[e.uniqueID] || (h[e.uniqueID] = {}), r && r === e.nodeName.toLowerCase()) e = e[n] || e;
                                    ...
                                    if ((u = c[o]) && u[0] === B && u[1] === a) return f[2] = u[2];
            ...
            function y(t, e, i, r, o, s) {
                return r && !r[q] && (r = y(r)), o && !o[q] && (o = y(o, s)), n(function(n, s, a, l) {
                    var u, c, h, f = [],
                        p = [],
                        d = s.length,
                        m = n || g(e || "*", a.nodeType ? [a] : a, []),
                        y = !t || !n && e ? m : v(m, f, t, a, l),
                        _ = i ? o || (n ? t : d || r) ? [] : s : y;
                    if (i && i(y, _, a, l), r)
                        for (u = v(_, p), r(u, [], a, l), c = u.length; c--;)(h = u[c]) && (_[p[c]] = !(y[p[c]] = h));
                    if (n) {
                        if (o || t) {
                            if (o) {
                            ...
                            for (c = _.length; c--;)(h = _[c]) && (u = o ? et(n, h) : f[c]) > -1 && (n[u] = !(s[u] = h))
                        }
                    } else _ = v(_ === s ? _.splice(d, _.length) : _), o ? o(null, s, _, l) : K.apply(s, _)
                })
            }
            ...
            function _(t) {
                for (var e, i, n, r = t.length, o = b.relative[t[0].type], s = o || b.relative[" "], a = o ? 1 : 0, l = d(function(t) {
                    ...
                    if (i = b.relative[t[a].type]) c = [d(m(c), i)];
                    else {
                        if (i = b.filter[t[a].type].apply(null, t[a].matches), i[q]) {
                ...
                var r = i.length > 0,
                    ...
                    s = function(n, s, a, l, u) {
                        ...
                        for (u && (P = s === D || s || u); d !== w && null != (c = _[d]); d++) {
                            if (o && c) {
                                for (h = 0, s || c.ownerDocument === D || (L(c), a = !R); f = t[h++];)
                                    if (f(c, s || D, a)) {
                                        l.push(c);
                                        break
                                    } u && (B = x)
            ...
            var w, T, b, S, C, k, E, O, P, M, A, L, D, I, R, N, F, z, j, q = "sizzle" + 1 * new Date,
                W = t.document,
                B = 0,
                H = 0,
                X = i(),
            ...
            try {
                K.apply(Q = tt.call(W.childNodes), W.childNodes), Q[W.childNodes.length].nodeType
            } catch (t) {
                K = {
            ...
            T = e.support = {}, C = e.isXML = function(t) {
                ...
                return n !== D && 9 === n.nodeType && n.documentElement ? (D = n, I = D.documentElement, R = !C(D), W !== D && (i = D.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", bt, !1) : i.attachEvent && i.attachEvent("onunload", bt)), T.attributes = r(function(t) {
                    return t.className = "i", !t.getAttribute("className")
                }), T.getElementsByTagName = r(function(t) {
                    return t.appendChild(D.createComment("")), !t.getElementsByTagName("*").length
                }), T.getElementsByClassName = vt.test(D.getElementsByClassName), T.getById = r(function(t) {
                    return I.appendChild(t).id = q, !D.getElementsByName || !D.getElementsByName(q).length
                ...
                }, F = [], N = [], (T.qsa = vt.test(D.querySelectorAll)) && (r(function(t) {
                    I.appendChild(t).innerHTML = "<a id='" + q + "'></a><select id='" + q + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                        t.querySelectorAll("[msallowcapture^='']").length && N.push("[*^$]=" + nt + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || N.push("\\[" + nt + "*(?:value|" + it + ")"), t.querySelectorAll("[id~=" + q + "-]").length || N.push("~="), t.querySelectorAll(":checked").length || N.push(":checked"), t.querySelectorAll("a#" + q + "+*").length || N.push(".#.+[+~]")
                }), r(function(t) {
                    t.innerHTML = "<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
                    var e = D.createElement("input");
                    e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), t.querySelectorAll("[name=d]").length && N.push("name" + nt + "*[*^$|!~]?="), 2 !== t.querySelectorAll(":enabled").length && N.push(":enabled", ":disabled"), I.appendChild(t).disabled = !0, 2 !== t.querySelectorAll(":disabled").length && N.push(":enabled", ":disabled"), t.querySelectorAll("*,:x"), N.push(",.*:")
                    ...
                    T.disconnectedMatch = z.call(t, "*"), z.call(t, "[s!='']:x"), F.push("!=", st)
                }), N = N.length && new RegExp(N.join("|")), F = F.length && new RegExp(F.join("|")), e = vt.test(I.compareDocumentPosition), j = e || vt.test(I.contains) ? function(t, e) {
                    ...
                    return i ? i : (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !T.sortDetached && e.compareDocumentPosition(t) === i ? t === D || t.ownerDocument === W && j(W, t) ? -1 : e === D || e.ownerDocument === W && j(W, e) ? 1 : M ? et(M, t) - et(M, e) : 0 : 4 & i ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return A = !0, 0;
                    var i, n = 0,
                        r = t.parentNode,
                        ...
                        a = [t],
                        l = [e];
                    if (!r || !o) return t === D ? -1 : e === D ? 1 : r ? -1 : o ? 1 : M ? et(M, t) - et(M, e) : 0;
                    if (r === o) return s(t, e);
                ...
                if ((t.ownerDocument || t) !== D && L(t), i = i.replace(ht, "='$1']"), T.matchesSelector && R && !U[i + " "] && (!F || !F.test(i)) && (!N || !N.test(i))) try {
                    var n = z.call(t, i);
                    if (n || T.disconnectedMatch || t.document && 11 !== t.document.nodeType) return n
                } catch (t) {}
                return e(i, D, null, [t]).length > 0
            }, e.contains = function(t, e) {
                return (t.ownerDocument || t) !== D && L(t), j(t, e)
            }, e.attr = function(t, e) {
                ...
                var e, i = [],
                    n = 0,
                    r = 0;
                if (A = !T.detectDuplicates, M = !T.sortStable && t.slice(0), t.sort(V), A) {
                ...
                preFilter: {
                    ...
                    PSEUDO: function(t) {
                        var e, i = !t[6] && t[2];
                        return dt.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && ft.test(i) && (e = k(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e), t[2] = i.slice(0, e)), t.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function(t) {
                        ...
                        return 1 === n && 0 === r ? function(t) {
                            ...
                            if (g) {
                                ...
                                if (d = [s ? g.firstChild : g.lastChild], s && y) {
                                    for (f = g, h = f[q] || (f[q] = {}), c = h[f.uniqueID] || (h[f.uniqueID] = {}), u = c[t] || [], p = u[0] === B && u[1], _ = p && u[2], f = p && g.childNodes[p]; f = ++p && f && f[m] || (_ = p = 0) || d.pop();)
                                        if (1 === f.nodeType && ++_ && f === e) {
                                            c[t] = [B, p, _];
                                            break
                                        }
                                } else if (y && (f = e, h = f[q] || (f[q] = {}), c = h[f.uniqueID] || (h[f.uniqueID] = {}), u = c[t] || [], p = u[0] === B && u[1], _ = p), _ === !1)
                                    for (;
                                        (f = ++p && f && f[m] || (_ = p = 0) || d.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++_ || (y && (h = f[q] || (f[q] = {}), c = h[f.uniqueID] || (h[f.uniqueID] = {}), c[t] = [B, _]), f !== e)););
                    ...
                    PSEUDO: function(t, i) {
                        ...
                        return o[q] ? o(i) : o.length > 1 ? (r = [t, t, "", i], b.setFilters.hasOwnProperty(t.toLowerCase()) ? n(function(t, e) {
            ...
            return f.prototype = b.filters = b.pseudos, b.setFilters = new f, k = e.tokenize = function(t, i) {
                ...
                var i, n = [],
                    ...
                    o = U[t + " "];
                if (!o) {
                    for (e || (e = k(t)), i = e.length; i--;) o = _(e[i]), o[q] ? n.push(o) : r.push(o);
                    o = U(t, x(r, n)), o.selector = t
                }
                return o
            }, O = e.select = function(t, e, i, n) {
                var r, o, s, a, l, u = "function" == typeof t && t,
                    c = !n && k(t = u.selector || t);
                if (i = i || [], 1 === c.length) {
                    if (o = c[0] = c[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && 9 === e.nodeType && R && b.relative[o[1].type]) {
                        if (e = (b.find.ID(s.matches[0].replace(_t, xt), e) || [])[0], !e) return i;
                ...
                return (u || E(t, c))(n, e, !R, i, !e || $.test(t) && h(e.parentNode) || e), i
            }, T.sortStable = q.split("").sort(V).join("") === q, T.detectDuplicates = !!A, L(), T.sortDetached = r(function(t) {
        ...
        dt.find = _t, dt.expr = _t.selectors, dt.expr[":"] = dt.expr.pseudos, dt.uniqueSort = dt.unique = _t.uniqueSort, dt.text = _t.getText, dt.isXMLDoc = _t.isXML, dt.contains = _t.contains, dt.escapeSelector = _t.escape;
        ...
        var Ct, kt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
            Et = dt.fn.init = function(t, e, i) {
                ...
                if (i = i || Ct, "string" == typeof t) {
                    ...
                    if (n[1]) {
                        if (e = e instanceof dt ? e[0] : e, dt.merge(this, dt.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : et, !0)), bt.test(n[1]) && dt.isPlainObject(e))
        ...
        dt.fn.extend({
            ...
            dt.fn[t] = function(i, n) {
                ...
                return "Until" !== t.slice(-5) && (n = i), n && "string" == typeof n && (r = dt.filter(n, r)), this.length > 1 && (Pt[t] || dt.uniqueSort(r), Ot.test(t) && r.reverse()), this.pushStack(r)
            }
        });
        var Mt = /[^\x20\t\r\n\f]+/g;
        dt.Callbacks = function(t) {
                    ...
                    r = {
                        ...
                        then: function(e, n, r) {
                                    ...
                                    var u = this,
                                        ...
                                        h = function() {
                                            ...
                                            if (!(e < s)) {
                                                ...
                                                h = t && ("object" == typeof t || "function" == typeof t) && t.then, dt.isFunction(h) ? r ? h.call(t, o(s, i, a, r), o(s, i, l, r)) : (s++, h.call(t, o(s, i, a, r), o(s, i, l, r), o(s, i, a, i.notifyWith))) : (n !== a && (u = void 0, c = [t]), (r || i.resolveWith)(u, c))
                                            }
                                        },
                                        f = r ? h : function() {
                                            try {
                                                ...
                                                dt.Deferred.exceptionHook && dt.Deferred.exceptionHook(t, f.stackTrace), e + 1 >= s && (n !== l && (u = void 0, c = [t]), i.rejectWith(u, c))
                                            }
                                        };
                            ...
                            return dt.Deferred(function(t) {
                                i[0][3].add(o(0, t, dt.isFunction(r) ? r : a, t.notifyWith)), i[1][3].add(o(0, t, dt.isFunction(e) ? e : a)), i[2][3].add(o(0, t, dt.isFunction(n) ? n : l))
                            }).promise()
                        },
                        promise: function(t) {
            ...
            when: function(t) {
                ...
                if (e <= 1 && (u(t, o.done(s(i)).resolve, o.reject), "pending" === o.state() || dt.isFunction(r[i] && r[i].then))) return o.then();
        ...
        dt.fn.ready = function(t) {
            ...
            ready: function(t) {
                (t === !0 ? --dt.readyWait : dt.isReady) || (dt.isReady = !0, t !== !0 && --dt.readyWait > 0 || Lt.resolveWith(et, [dt]))
            }
        }), dt.ready.then = Lt.then, "complete" === et.readyState || "loading" !== et.readyState && !et.documentElement.doScroll ? t.setTimeout(dt.ready) : (et.addEventListener("DOMContentLoaded", c), t.addEventListener("load", c));
        var Dt = function(t, e, i, n, r, o, s) {
                ...
                if ("object" === dt.type(i)) {
                    r = !0;
                    for (a in i) Dt(t, e, a, i[a], !0, o, s)
                } else if (void 0 !== n && (r = !0, dt.isFunction(n) || (s = !0), u && (s ? (e.call(t, n), e = null) : (u = e, e = function(t, e, i) {
        ...
        h.uid = 1, h.prototype = {
            ...
            remove: function(t, e) {
                ...
                if (void 0 !== n) {
                    if (void 0 !== e) {
                        dt.isArray(e) ? e = e.map(dt.camelCase) : (e = dt.camelCase(e), e = e in n ? [e] : e.match(Mt) || []), i = e.length;
                        for (; i--;) delete n[e[i]]
        ...
        dt.extend({
            ...
            data: function(t, e) {
                var i, n, r, o = this[0],
                    s = o && o.attributes;
                if (void 0 === t) {
                    if (this.length && (r = Nt.get(o), 1 === o.nodeType && !Rt.get(o, "hasDataAttrs"))) {
                        for (i = s.length; i--;) s[i] && (n = s[i].name, 0 === n.indexOf("data-") && (n = dt.camelCase(n.slice(5)), $(o, n, r[n])));
                ...
                return "object" == typeof t ? this.each(function() {
                    ...
                    var i;
                    if (o && void 0 === e) {
                        if (i = Nt.get(o, t), void 0 !== i) return i;
                        if (i = $(o, t), void 0 !== i) return i
            ...
            queue: function(t, e, i) {
                var n;
                if (t) return e = (e || "fx") + "queue", n = Rt.get(t, e), i && (!n || dt.isArray(i) ? n = Rt.access(t, e, dt.makeArray(i)) : n.push(i)), n || []
            },
            ...
            promise: function(t, e) {
                ...
                for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; s--;) i = Rt.get(o[s], t + "queueHooks"), i && i.empty && (n++, i.empty.add(a));
        ...
        dt.event = {
            ...
            add: function(t, e, i, n, r) {
                ...
                if (g)
                    for (i.handler && (o = i, i = o.handler, r = o.selector), r && dt.find.matchesSelector(Qt, r), i.guid || (i.guid = dt.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function(e) {
                            return "undefined" != typeof dt && dt.event.triggered !== e.type ? dt.event.dispatch.apply(t, arguments) : void 0
                        }), e = (e || "").match(Mt) || [""], u = e.length; u--;) a = Kt.exec(e[u]) || [], p = m = a[1], d = (a[2] || "").split(".").sort(), p && (h = dt.event.special[p] || {}, p = (r ? h.delegateType : h.bindType) || p, h = dt.event.special[p] || {}, c = dt.extend({
                        type: p,
                        origType: m,
                        data: n,
                        handler: i,
                        ...
                        namespace: d.join(".")
                    }, o), (f = l[p]) || (f = l[p] = [], f.delegateCount = 0, h.setup && h.setup.call(t, n, d, s) !== !1 || t.addEventListener && t.addEventListener(p, s)), h.add && (h.add.call(t, c), c.handler.guid || (c.handler.guid = i.guid)), r ? f.splice(f.delegateCount++, 0, c) : f.push(c), dt.event.global[p] = !0)
            },
                ...
                if (g && (l = g.events)) {
                    for (e = (e || "").match(Mt) || [""], u = e.length; u--;)
                        if (a = Kt.exec(e[u]) || [], p = m = a[1], d = (a[2] || "").split(".").sort(), p) {
                            for (h = dt.event.special[p] || {}, p = (n ? h.delegateType : h.bindType) || p, f = l[p] || [], a = a[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = f.length; o--;) c = f[o], !r && m !== c.origType || i && i.guid !== c.guid || a && !a.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (f.splice(o, 1), c.selector && f.delegateCount--, h.remove && h.remove.call(t, c));
                            s && !f.length && (h.teardown && h.teardown.call(t, d, g.handle) !== !1 || dt.removeEvent(t, p, g.handle), delete l[p])
                        } else
                            for (p in l) dt.event.remove(t, p + e[u], i, n, !0);
                    dt.isEmptyObject(l) && Rt.remove(t, "handle events")
                }
            },
            dispatch: function(t) {
                var e = dt.event.fix(t),
                    i, n, r, o, s, a, l = new Array(arguments.length),
                    u = (Rt.get(this, "events") || {})[e.type] || [],
                ...
                if (e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
                    for (a = dt.event.handlers.call(this, e, u), i = 0;
                        (o = a[i++]) && !e.isPropagationStopped();)
                        for (e.currentTarget = o.elem, n = 0;
                            (s = o.handlers[n++]) && !e.isImmediatePropagationStopped();) e.rnamespace && !e.rnamespace.test(s.namespace) || (e.handleObj = s, e.data = s.data, r = ((dt.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, l), void 0 !== r && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation()));
                ...
                if (l && u.nodeType && !("click" === t.type && t.button >= 1))
                    for (; u !== this; u = u.parentNode || this)
                        if (1 === u.nodeType && ("click" !== t.type || u.disabled !== !0)) {
                            for (o = [], s = {}, i = 0; i < l; i++) n = e[i], r = n.selector + " ", void 0 === s[r] && (s[r] = n.needsContext ? dt(r, this).index(u) > -1 : dt.find(r, this, null, [u]).length), s[r] && o.push(n);
                            o.length && a.push({
                                elem: u,
                                handlers: o
                            })
            ...
            return this instanceof dt.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && t.returnValue === !1 ? _ : x, this.target = t.target && 3 === t.target.nodeType ? t.target.parentNode : t.target, this.currentTarget = t.currentTarget, this.relatedTarget = t.relatedTarget) : this.type = t, e && dt.extend(this, e), this.timeStamp = t && t.timeStamp || dt.now(), void(this[dt.expando] = !0)) : new dt.Event(t, e)
        }, dt.Event.prototype = {
            ...
            dt.event.special[t] = {
                ...
                handle: function(t) {
                    var i, n = this,
                        r = t.relatedTarget,
                        o = t.handleObj;
                    return r && (r === n || dt.contains(n, r)) || (t.type = o.origType, i = o.handler.apply(this, arguments), t.type = e), i
                }
            }
        }), dt.fn.extend({
            on: function(t, e, i, n) {
        ...
        dt.extend({
            ...
            clone: function(t, e, i) {
                ...
                if (!(ft.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || dt.isXMLDoc(t)))
                    for (s = g(a), o = g(t), n = 0, r = o.length; n < r; n++) E(o[n], s[n]);
                if (e)
                    if (i)
                        for (o = o || g(t), s = s || g(a), n = 0, r = o.length; n < r; n++) k(o[n], s[n]);
                    else k(t, a);
            ...
            dt.fn[t] = function(t) {
                for (var i, n = [], r = dt(t), o = r.length - 1, s = 0; s <= o; s++) i = s === o ? this : this.clone(!0), dt(r[s])[e](i), ot.apply(n, i.get());
        ...
        ! function() {
            function e() {
                if (a) {
                    ...
                    i = "1%" !== e.top, o = "2px" === e.marginLeft, n = "4px" === e.width, a.style.marginRight = "50%", r = "4px" === e.marginRight, Qt.removeChild(s), a = null
                }
            }
            var i, n, r, o, s = et.createElement("div"),
                a = et.createElement("div");
            a.style && (a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", ft.clearCloneStyle = "content-box" === a.style.backgroundClip, s.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", s.appendChild(a), dt.extend(ft, {
        ...
        dt.extend({
            ...
            style: function(t, e, i, n) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var r, o, s, a = dt.camelCase(e),
                        l = t.style;
                    return e = dt.cssProps[a] || (dt.cssProps[a] = L(a) || a), s = dt.cssHooks[e] || dt.cssHooks[a], void 0 === i ? s && "get" in s && void 0 !== (r = s.get(t, !1, n)) ? r : l[e] : (o = typeof i, "string" === o && (r = qt.exec(i)) && r[1] && (i = p(t, e, r), o = "number"), void(null != i && i === i && ("number" === o && (i += r && r[3] || (dt.cssNumber[a] ? "" : "px")), ft.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"), s && "set" in s && void 0 === (i = s.set(t, i, n)) || (l[e] = i))))
                }
            },
            css: function(t, e, i, n) {
                var r, o, s, a = dt.camelCase(e);
                return e = dt.cssProps[a] || (dt.cssProps[a] = L(a) || a), s = dt.cssHooks[e] || dt.cssHooks[a], s && "get" in s && (r = s.get(t, !0, i)), void 0 === r && (r = M(t, e, n)), "normal" === r && e in ce && (r = ce[e]), "" === i || i ? (o = parseFloat(r), i === !0 || isFinite(o) ? o || 0 : r) : r
            }
        }), dt.each(["height", "width"], function(t, e) {
            dt.cssHooks[e] = {
                get: function(t, i, n) {
                    if (i) return !le.test(dt.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? R(t, e, n) : Bt(t, ue, function() {
                        return R(t, e, n)
                    })
                },
                set: function(t, i, n) {
                    var r, o = n && ae(t),
                        s = n && I(t, e, n, "border-box" === dt.css(t, "boxSizing", !1, o), o);
                    return s && (r = qt.exec(i)) && "px" !== (r[3] || "px") && (t.style[e] = i, i = dt.css(t, e)), D(t, i, s)
                }
            }
        }), dt.cssHooks.marginLeft = A(ft.reliableMarginLeft, function(t, e) {
            if (e) return (parseFloat(M(t, "marginLeft")) || t.getBoundingClientRect().left - Bt(t, {
                marginLeft: 0
            }, function() {
            ...
            css: function(t, e) {
                return Dt(this, function(t, e, i) {
                    var n, r, o = {},
                        s = 0;
                    if (dt.isArray(e)) {
                        for (n = ae(t), r = e.length; s < r; s++) o[e[s]] = dt.css(t, e[s], !1, n);
                        return o
                    }
                    return void 0 !== i ? dt.style(t, e, i) : dt.css(t, e)
                }, t, e, arguments.length > 1)
            }
        }), dt.Tween = N, N.prototype = {
            constructor: N,
            init: function(t, e, i, n, r, o) {
                this.elem = t, this.prop = i, this.easing = r || dt.easing._default, this.options = e, this.start = this.now = this.cur(), this.end = n, this.unit = o || (dt.cssNumber[i] ? "" : "px")
            },
            cur: function() {
            ...
            run: function(t) {
                ...
                return this.options.duration ? this.pos = e = dt.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), i && i.set ? i.set(this) : N.propHooks._default.set(this), this
            }
            ...
            _default: "swing"
        }, dt.fx = N.prototype.init, dt.fx.step = {};
        ...
        dt.Animation = dt.extend(H, {
                ...
                tweener: function(t, e) {
                    dt.isFunction(t) ? (e = t, t = ["*"]) : t = t.match(Mt);
                ...
                return dt.fx.off || et.hidden ? n.duration = 0 : "number" != typeof n.duration && (n.duration in dt.fx.speeds ? n.duration = dt.fx.speeds[n.duration] : n.duration = dt.fx.speeds._default), null != n.queue && n.queue !== !0 || (n.queue = "fx"), n.old = n.complete, n.complete = function() {
                ...
                finish: function(t) {
                    return t !== !1 && (t = t || "fx"), this.each(function() {
                        var e, i = Rt.get(this),
                            ...
                            o = dt.timers,
                            s = n ? n.length : 0;
                        for (i.finish = !0, dt.queue(this, t, []), r && r.stop && r.stop.call(this, !0), e = o.length; e--;) o[e].elem === this && o[e].queue === t && (o[e].anim.stop(!0), o.splice(e, 1));
                ...
                var t, e = 0,
                    i = dt.timers;
                for (pe = dt.now(); e < i.length; e++) t = i[e], t() || i[e] !== t || i.splice(e--, 1);
            ...
            function() {
                ...
                t.type = "checkbox", ft.checkOn = "" !== t.value, ft.optSelected = i.selected, t = et.createElement("input"), t.value = "t", t.type = "radio", ft.radioValue = "t" === t.value
            }();
        ...
        dt.fn.extend({
            ...
            attr: function(t, e, i) {
                ...
                if (3 !== o && 8 !== o && 2 !== o) return "undefined" == typeof t.getAttribute ? dt.prop(t, e, i) : (1 === o && dt.isXMLDoc(t) || (r = dt.attrHooks[e.toLowerCase()] || (dt.expr.match.bool.test(e) ? ve : void 0)), void 0 !== i ? null === i ? void dt.removeAttr(t, e) : r && "set" in r && void 0 !== (n = r.set(t, i, e)) ? n : (t.setAttribute(e, i + ""), i) : r && "get" in r && null !== (n = r.get(t, e)) ? n : (n = dt.find.attr(t, e), null == n ? void 0 : n))
            },
            attrHooks: {
                type: {
                    set: function(t, e) {
            ...
            ye[e] = function(t, e, n) {
                ...
                return n || (o = ye[s], ye[s] = r, r = null != i(t, e, n) ? s : null, ye[s] = o), r
            }
        });
        ...
        dt.fn.extend({
            ...
            prop: function(t, e, i) {
                var n, r, o = t.nodeType;
                if (3 !== o && 8 !== o && 2 !== o) return 1 === o && dt.isXMLDoc(t) || (e = dt.propFix[e] || e, r = dt.propHooks[e]), void 0 !== i ? r && "set" in r && void 0 !== (n = r.set(t, i, e)) ? n : t[e] = i : r && "get" in r && null !== (n = r.get(t, e)) ? n : t[e]
            },
            propHooks: {
                tabIndex: {
                    get: function(t) {
            ...
            toggleClass: function(t, e) {
                ...
                return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : dt.isFunction(t) ? this.each(function(i) {
                    ...
                    var e, n, r, o;
                    if ("string" === i)
                        for (n = 0, r = dt(this), o = t.match(Mt) || []; e = o[n++];) r.hasClass(e) ? r.removeClass(e) : r.addClass(e);
                    else void 0 !== t && "boolean" !== i || (e = Y(this), e && Rt.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || t === !1 ? "" : Rt.get(this, "__className__") || ""))
                })
            },
            hasClass: function(t) {
                var e, i, n = 0;
                for (e = " " + t + " "; i = this[n++];)
                    if (1 === i.nodeType && (" " + X(Y(i)) + " ").indexOf(e) > -1) return !0;
                return !1
            }
        });
        var we = /\r/g;
        dt.fn.extend({
            val: function(t) {
                ...
                })) : r ? (e = dt.valHooks[r.type] || dt.valHooks[r.nodeName.toLowerCase()], e && "get" in e && void 0 !== (i = e.get(r, "value")) ? i : (i = r.value, "string" == typeof i ? i.replace(we, "") : null == i ? "" : i)) : void 0
            }
        }), dt.extend({
            valHooks: {
                option: {
                ...
                select: {
                    get: function(t) {
                        ...
                        for (n = o < 0 ? l : s ? o : 0; n < l; n++)
                            if (i = r[n], (i.selected || n === o) && !i.disabled && (!i.parentNode.disabled || !dt.nodeName(i.parentNode, "optgroup"))) {
                                if (e = dt(i).val(), s) return e;
                                a.push(e)
                            } return a
                    },
                    set: function(t, e) {
                        for (var i, n, r = t.options, o = dt.makeArray(e), s = r.length; s--;) n = r[s], (n.selected = dt.inArray(dt.valHooks.option.get(n), o) > -1) && (i = !0);
        ...
        dt.extend(dt.event, {
            trigger: function(e, i, n, r) {
                var o, s, a, l, u, c, h, f = [n || et],
                    p = ut.call(e, "type") ? e.type : e,
                    d = ut.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = a = n = n || et, 3 !== n.nodeType && 8 !== n.nodeType && !Te.test(p + dt.event.triggered) && (p.indexOf(".") > -1 && (d = p.split("."), p = d.shift(), d.sort()), u = p.indexOf(":") < 0 && "on" + p, e = e[dt.expando] ? e : new dt.Event(p, "object" == typeof e && e), e.isTrigger = r ? 2 : 3, e.namespace = d.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : dt.makeArray(i, [e]), h = dt.event.special[p] || {}, r || !h.trigger || h.trigger.apply(n, i) !== !1)) {
                    if (!r && !h.noBubble && !dt.isWindow(n)) {
                        for (l = h.delegateType || p, Te.test(l + p) || (s = s.parentNode); s; s = s.parentNode) f.push(s), a = s;
                        a === (n.ownerDocument || et) && f.push(a.defaultView || a.parentWindow || t)
                    }
                    for (o = 0;
                        (s = f[o++]) && !e.isPropagationStopped();) e.type = o > 1 ? l : h.bindType || p, c = (Rt.get(s, "events") || {})[e.type] && Rt.get(s, "handle"), c && c.apply(s, i), c = u && s[u], c && c.apply && It(s) && (e.result = c.apply(s, i), e.result === !1 && e.preventDefault());
                    return e.type = p, r || e.isDefaultPrevented() || h._default && h._default.apply(f.pop(), i) !== !1 || !It(n) || u && dt.isFunction(n[p]) && !dt.isWindow(n) && (a = n[u], a && (n[u] = null), dt.event.triggered = p, n[p](), dt.event.triggered = void 0, a && (n[u] = a)), e.result
                }
            },
            ...
            dt.event.special[e] = {
                setup: function() {
                    var n = this.ownerDocument || this,
                        r = Rt.access(n, e);
                    r || n.addEventListener(t, i, !0), Rt.access(n, e, (r || 0) + 1)
                },
                teardown: function() {
                    var n = this.ownerDocument || this,
                        r = Rt.access(n, e) - 1;
                    r ? Rt.access(n, e, r) : (n.removeEventListener(t, i, !0), Rt.remove(n, e))
                }
            }
        });
        var be = t.location,
        ...
        qe.href = be.href, dt.extend({
            ...
            ajax: function(e, i) {
                function n(e, i, n, a) {
                    var u, f, p, x, w, T = i;
                    c || (c = !0, l && t.clearTimeout(l), r = void 0, s = a || "", b.readyState = e > 0 ? 4 : 0, u = e >= 200 && e < 300 || 304 === e, n && (x = Z(d, b, n)), x = J(d, x, b, u), u ? (d.ifModified && (w = b.getResponseHeader("Last-Modified"), w && (dt.lastModified[o] = w), w = b.getResponseHeader("etag"), w && (dt.etag[o] = w)), 204 === e || "HEAD" === d.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = x.state, f = x.data, p = x.error, u = !p)) : (p = T, !e && T || (T = "error", e < 0 && (e = 0))), b.status = e, b.statusText = (i || T) + "", u ? v.resolveWith(m, [f, T, b]) : v.rejectWith(m, [b, T, p]), b.statusCode(_), _ = void 0, h && g.trigger(u ? "ajaxSuccess" : "ajaxError", [b, d, u ? f : p]), y.fireWith(m, [b, T]), h && (g.trigger("ajaxComplete", [b, d]), --dt.active || dt.event.trigger("ajaxStop")))
                }
                "object" == typeof e && (i = e, e = void 0), i = i || {};
                var r, o, s, a, l, u, c, h, f, p, d = dt.ajaxSetup({}, i),
                    m = d.context || d,
                ...
                if (v.promise(b), d.url = ((e || d.url || be.href) + "").replace(Ne, be.protocol + "//"), d.type = i.method || i.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(Mt) || [""], null == d.crossDomain) {
                ...
                if (d.data && d.processData && "string" != typeof d.data && (d.data = dt.param(d.data, d.traditional)), G(Fe, d, i, b), c) return b;
                h = dt.event && d.global, h && 0 === dt.active++ && dt.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Re.test(d.type), o = d.url.replace(Ae, ""), d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(Me, "+")) : (p = d.url.slice(o.length), d.data && (o += (Ce.test(o) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (o = o.replace(Le, "$1"), p = (Ce.test(o) ? "&" : "?") + "_=" + Se++ + p), d.url = o + p), d.ifModified && (dt.lastModified[o] && b.setRequestHeader("If-Modified-Since", dt.lastModified[o]), dt.etag[o] && b.setRequestHeader("If-None-Match", dt.etag[o])), (d.data && d.hasContent && d.contentType !== !1 || i.contentType) && b.setRequestHeader("Content-Type", d.contentType), b.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + je + "; q=0.01" : "") : d.accepts["*"]);
                for (f in d.headers) b.setRequestHeader(f, d.headers[f]);
                if (d.beforeSend && (d.beforeSend.call(m, b, d) === !1 || c)) return b.abort();
                if (T = "abort", y.add(d.complete), b.done(d.success), b.fail(d.error), r = G(ze, d, i, b)) {
                    if (b.readyState = 1, h && g.trigger("ajaxSend", [b, d]), c) return b;
        ...
        ft.cors = !!We && "withCredentials" in We, ft.ajax = We = !!We, dt.ajaxTransport(function(e) {
            var i, n;
            if (ft.cors || We && !e.crossDomain) return {
                send: function(r, o) {
                    var s, a = e.xhr();
                    ...
                    i = function(t) {
                        return function() {
                            i && (i = n = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o($e[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                binary: a.response
                            } : {
                                text: a.responseText
        ...
        dt.ajaxSetup({
            ...
            if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = dt.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(He, "$1" + r) : e.jsonp !== !1 && (e.url += (Ce.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
                return s || dt.error(r + " was not called"), s[0]
            }, e.dataTypes[0] = "json", o = t[r], t[r] = function() {
                s = arguments
            }, n.always(function() {
                void 0 === o ? dt(t).removeProp(r) : t[r] = o, e[r] && (e.jsonpCallback = i.jsonpCallback, Be.push(r)), s && dt.isFunction(o) && o(s[0]), s = o = void 0
            }), "script"
            ...
            var n, r, o;
            return e || (ft.createHTMLDocument ? (e = et.implementation.createHTMLDocument(""), n = e.createElement("base"), n.href = et.location.href, e.head.appendChild(n)) : e = et), r = bt.exec(t), o = !i && [], r ? [e.createElement(r[1])] : (r = y([t], e, o), o && o.length && dt(o).remove(), dt.merge([], r.childNodes))
        }, dt.fn.load = function(t, e, i) {
            var n, r, o, s = this,
                a = t.indexOf(" ");
            return a > -1 && (n = X(t.slice(a)), t = t.slice(0, a)), dt.isFunction(e) ? (i = e, e = void 0) : e && "object" == typeof e && (r = "POST"), s.length > 0 && dt.ajax({
                url: t,
                type: r || "GET",
                dataType: "html",
                data: e
            }).done(function(t) {
                o = arguments, s.html(n ? dt("<div>").append(dt.parseHTML(t)).find(n) : t)
            ...
            setOffset: function(t, e, i) {
                var n, r, o, s, a, l, u, c = dt.css(t, "position"),
                    h = dt(t),
                    f = {};
                "static" === c && (t.style.position = "relative"), a = h.offset(), o = dt.css(t, "top"), l = dt.css(t, "left"), u = ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1, u ? (n = h.position(), s = n.top, r = n.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), dt.isFunction(e) && (e = e.call(t, i, dt.extend({}, a))), null != e.top && (f.top = e.top - a.top + s), null != e.left && (f.left = e.left - a.left + r), "using" in e ? e.using.call(t, f) : h.css(f)
            }
        }, dt.fn.extend({
            offset: function(t) {
                ...
                return o ? o.getClientRects().length ? (n = o.getBoundingClientRect(), n.width || n.height ? (r = o.ownerDocument, i = K(r), e = r.documentElement, {
            ...
            dt.cssHooks[e] = A(ft.pixelPosition, function(t, i) {
                if (i) return i = M(t, e), se.test(i) ? dt(t).position()[e] + "px" : i
            })
        }), dt.each({
            Height: "height",
            Width: "width"
            ...
            dt.each({
                ...
                dt.fn[n] = function(r, o) {
                    ...
                    return Dt(this, function(e, i, r) {
                        var o;
                        return dt.isWindow(e) ? 0 === n.indexOf("outer") ? e["inner" + t] : e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement, Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === r ? dt.css(e, i, a) : dt.style(e, i, r, a)
                    }, e, s ? r : void 0, s)
                }
            })
        }), dt.fn.extend({
        ...
        return dt.noConflict = function(e) {
            return t.$ === dt && (t.$ = Ye), e && t.jQuery === dt && (t.jQuery = Xe), dt
        }, e || (t.jQuery = t.$ = dt), dt
    }), ! function(t, e, i) {
        function n(t, e) {
            return typeof t === e
        ...
        function r() {
            ...
            for (var l in _)
                if (_.hasOwnProperty(l)) {
                    ...
                    for (r = n(e.fn, "function") ? e.fn() : e.fn, o = 0; o < t.length; o++) s = t[o], a = s.split("."), 1 === a.length ? w[a[0]] = r : (!w[a[0]] || w[a[0]] instanceof Boolean || (w[a[0]] = new Boolean(w[a[0]])), w[a[0]][a[1]] = r), y.push((r ? "" : "no-") + a.join("-"))
                }
        }
        ...
        function o(t) {
            ...
            if (b && (e = e.baseVal), w._config.enableJSClass) {
                var n = new RegExp("(^|\\s)" + i + "no-js(\\s|$)");
                e = e.replace(n, "$1" + i + "js$2")
            }
            w._config.enableClasses && (e += " " + i + t.join(" " + i), b ? T.className.baseVal = e : T.className = e)
        }
        ...
        function c(t, e, i) {
            var r;
            for (var o in t)
                if (t[o] in e) return i === !1 ? t[o] : (r = e[t[o]], n(r, "function") ? u(r, i || e) : r);
            return !1
        }
        ...
        function f() {
            var t = e.body;
            return t || (t = l(b ? "svg" : "body"), t.fake = !0), t
        }
        ...
        function p(t, i, n, r) {
            var o, s, a, u, c = "modernizr",
                ...
                p = f();
            if (parseInt(n, 10))
                for (; n--;) a = l("div"), a.id = r ? r[n] : c + (n + 1), h.appendChild(a);
            return o = l("style"), o.type = "text/css", o.id = "s" + c, (p.fake ? p : h).appendChild(o), p.appendChild(h), o.styleSheet ? o.styleSheet.cssText = t : o.appendChild(e.createTextNode(t)), h.id = c, p.fake && (p.style.background = "", p.style.overflow = "hidden", u = T.style.overflow, T.style.overflow = "hidden", T.appendChild(p)),
                s = i(h, t), p.fake ? (p.parentNode.removeChild(p), T.style.overflow = u, T.offsetHeight) : h.parentNode.removeChild(h), !!s
        }
        ...
        function m(t, e, r, o) {
            ...
            for (var h, f, p, m, g, v = ["modernizr", "tspan", "samp"]; !P.style && v.length;) h = !0, P.modElem = l(v.shift()), P.style = P.modElem.style;
            for (p = t.length, f = 0; p > f; f++)
                if (m = t[f], g = P.style[m], a(m, "-") && (m = s(m)), P.style[m] !== i) {
                    if (o || n(r, "undefined")) return u(), "pfx" != e || m;
                    try {
                        P.style[m] = r
                    } catch (t) {}
        ...
        function g(t, e, i, r, o) {
            ...
            return n(e, "string") || n(e, "undefined") ? m(a, e, r, o) : (a = (t + " " + E.join(s + " ") + s).split(" "), c(a, e, i))
        }
        ...
        w._q.unshift(function() {
            delete P.style
        }), x.testAllProps = g, x.prefixed = function(t, e, i) {
            return 0 === t.indexOf("@") ? k(t) : (-1 != t.indexOf("-") && (t = s(t)), e ? g(t, e, i) : g(t, "pfx"))
        }, x.testAllProps = v, w.addTest("cssanimations", v("animationName", "a", !0)), r(), o(y), delete x.addTest, delete x.addAsyncTest;
        for (var M = 0; M < w._q.length; M++) w._q[M]();
        t.Modernizr = w
    }(window, document),
    function() {
        var t, e, i, n, r, o, s, a, l, u, c, h, f, p, d, m, g, v, y, _, x, w, T, b, S, C, k, E, O, P, M, A, L, D, I, R, N, F, z, j, q, W, B, H, X, Y, U, V, G, Q = [].slice,
            Z = {}.hasOwnProperty,
            J = function(t, e) {
                function i() {
                    this.constructor = t
        ...
        for (x = {
            ...
            }, M = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, _ = window.cancelAnimationFrame || window.mozCancelAnimationFrame, null == M && (M = function(t) {
            ...
            }(), u = window.Pace || {}, window.Pace = u, w(u, s.prototype), P = u.options = w({}, x, window.paceOptions, b()), U = ["ajax", "document", "eventLag", "elements"], B = 0, X = U.length; X > B; B++) N = U[B], P[N] === !0 && (P[N] = x[N]);
        l = function(t) {
            function e() {
        ...
        }(), W = window.XMLHttpRequest, q = window.XDomainRequest, j = window.WebSocket, T = function(t, e) {
            var i, n, r;
            r = [];
            ...
            var t, e, i;
            return e = arguments[0], t = 2 <= arguments.length ? Q.call(arguments, 1) : [], k.unshift("ignore"), i = e.apply(null, t), k.shift(), i
        }, u.track = function() {
            var t, e, i;
            return e = arguments[0], t = 2 <= arguments.length ? Q.call(arguments, 1) : [], k.unshift("track"), i = e.apply(null, t), k.shift(), i
        }, R = function(t) {
            var e;
            ...
            var e, i, n, r;
            for (r = P.ajax.ignoreURLs, i = 0, n = r.length; n > i; i++)
            ...
            var i, n, r, o, s;
            return o = e.type, r = e.request, s = e.url, I(s) ? void 0 : u.running || P.restartOnRequestAfter === !1 && "force" !== R(o) ? void 0 : (n = arguments, i = P.restartOnRequestAfter || 0, "boolean" == typeof i && (i = 0), setTimeout(function() {
                var e, i, s, a, l, c;
                if (e = "socket" === o ? r.readyState < 2 : 0 < (a = r.readyState) && 4 > a) {
                    for (u.restart(), l = u.sources, c = [], i = 0, s = l.length; s > i; i++) {
            ...
            return t.prototype.watch = function(t) {
                var e, i, n, r;
                return n = t.type, e = t.request, r = t.url, I(r) ? void 0 : (i = "socket" === n ? new p(e) : new d(e), this.elements.push(i))
            }, t
        }(), d = function() {
            function t(t) {
            ...
            function t() {
                ...
                this.progress = 0, t = 0, r = [], n = 0, i = O(), e = setInterval(function() {
                    var s;
                    return s = O() - i - 50, i = O(), r.push(s), r.length > P.eventLag.sampleCount && r.shift(), t = g(r), ++n >= P.eventLag.minSamples && t < P.eventLag.lagThreshold ? (o.progress = 100, clearInterval(e)) : o.progress = 100 * (3 / (t + 3))
                }, 50)
            }
            return t
        }(), f = function() {
        ...
        }(), F = null, D = null, v = null, z = null, m = null, y = null, u.running = !1, C = function() {
            ...
            var t, i, n, r, o, s, a, l;
            for (u.sources = F = [], s = ["ajax", "elements", "document", "eventLag"], i = 0, r = s.length; r > i; i++) t = s[i], P[t] !== !1 && F.push(new h[t](P[t]));
            for (l = null != (a = P.extraSources) ? a : [], n = 0, o = l.length; o > n; n++) N = l[n], F.push(new N(P));
            return u.bar = v = new e, D = [], z = new f
        })(), u.stop = function() {
            ...
            var t;
            return u.running = !0, v.render(), t = O(), y = !1, m = L(function(e, i) {
                var n, r, o, s, a, l, c, h, p, d, m, g, _, x, w, T;
                for (h = 100 - v.progress, r = m = 0, o = !0, l = g = 0, x = F.length; x > g; l = ++g)
                    for (N = F[l], d = null != D[l] ? D[l] : D[l] = [], a = null != (T = N.elements) ? T : [N], c = _ = 0, w = a.length; w > _; c = ++_) s = a[c], p = null != d[c] ? d[c] : d[c] = new f(s), o &= p.done, p.done || (r++, m += p.tick(e));
                return n = m / r, v.update(z.tick(e, n)), v.done() || o || y ? (v.update(100), u.trigger("done"), setTimeout(function() {
    ...
    (_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
            ...
            _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
                    ...
                    o.version = "1.19.0", c.constructor = o, c.kill()._gc = !1, o.killTweensOf = o.killDelayedCallsTo = i.killTweensOf, o.getTweensOf = i.getTweensOf, o.lagSmoothing = i.lagSmoothing, o.ticker = i.ticker, o.render = i.render, c.invalidate = function() {
                        ...
                        var n, r, o, l, u, c, h, f, p = this._dirty ? this.totalDuration() : this._totalDuration,
                            d = this._time,
                            m = this._totalTime,
                            g = this._cycle,
                            v = this._duration,
                            y = this._rawPrevTime;
                        if (t >= p - 1e-7 ? (this._totalTime = p, this._cycle = this._repeat, this._yoyo && 0 !== (1 & this._cycle) ? (this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0) : (this._time = v, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1), this._reversed || (n = !0, r = "onComplete", i = i || this._timeline.autoRemoveChildren), 0 === v && (this._initted || !this.vars.lazy || i) && (this._startTime === this._timeline._duration && (t = 0), (0 > y || 0 >= t && t >= -1e-7 || y === s && "isPause" !== this.data) && y !== t && (i = !0, y > s && (r = "onReverseComplete")), this._rawPrevTime = f = !e || t || y === t ? t : s)) : 1e-7 > t ? (this._totalTime = this._time = this._cycle = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== m || 0 === v && y > 0) && (r = "onReverseComplete", n = this._reversed), 0 > t && (this._active = !1, 0 === v && (this._initted || !this.vars.lazy || i) && (y >= 0 && (i = !0), this._rawPrevTime = f = !e || t || y === t ? t : s)), this._initted || (i = !0)) : (this._totalTime = this._time = t, 0 !== this._repeat && (l = v + this._repeatDelay, this._cycle = this._totalTime / l >> 0, 0 !== this._cycle && this._cycle === this._totalTime / l && t >= m && this._cycle--, this._time = this._totalTime - this._cycle * l, this._yoyo && 0 !== (1 & this._cycle) && (this._time = v - this._time), this._time > v ? this._time = v : this._time < 0 && (this._time = 0)), this._easeType ? (u = this._time / v, c = this._easeType, h = this._easePower, (1 === c || 3 === c && u >= .5) && (u = 1 - u), 3 === c && (u *= 2), 1 === h ? u *= u : 2 === h ? u *= u * u : 3 === h ? u *= u * u * u : 4 === h && (u *= u * u * u * u), 1 === c ? this.ratio = 1 - u : 2 === c ? this.ratio = u : this._time / v < .5 ? this.ratio = u / 2 : this.ratio = 1 - u / 2) : this.ratio = this._ease.getRatio(this._time / v)), d === this._time && !i && g === this._cycle) return void(m !== this._totalTime && this._onUpdate && (e || this._callback("onUpdate")));
                        if (!this._initted) {
                        ...
                        for (this._lazy !== !1 && (this._lazy = !1), this._active || !this._paused && this._time !== d && t >= 0 && (this._active = !0), 0 === m && (2 === this._initted && t > 0 && this._init(), this._startAt && (t >= 0 ? this._startAt.render(t, e, i) : r || (r = "_dummyGS")), this.vars.onStart && (0 !== this._totalTime || 0 === v) && (e || this._callback("onStart"))), o = this._firstPT; o;) o.f ? o.t[o.p](o.c * this.ratio + o.s) : o.t[o.p] = o.c * this.ratio + o.s, o = o._next;
                        ...
                        for (u(t) || ("string" == typeof t && (t = i.selector(t) || t), l(t) && (t = n(t))), t = t || [], 0 > a && (t = n(t), t.reverse(), a *= -1), d = t.length - 1, g = 0; d >= g; g++) {
                            ...
                            m.delay = y + (m.delay || 0), g === d && c && (m.onComplete = x), _[g] = new o(t[g], e, m), y += a
                        }
                        return _
                    ...
                    return n.version = "1.19.0", g.constructor = n, g.kill()._gc = g._forcingPlayhead = g._hasPause = !1, g.to = function(t, e, n, r) {
                        ...
                        var h, d, g = new n({
                            ...
                            v = r.cycle;
                        for ("string" == typeof t && (t = i.selector(t) || t), t = t || [], a(t) && (t = m(t)), o = o || 0, 0 > o && (t = m(t), t.reverse(), o *= -1), d = 0; d < t.length; d++) h = f(r), h.startAt && (h.startAt = f(h.startAt), h.startAt.cycle && p(h.startAt, t, d)), v && (p(h, t, d), null != h.duration && (e = h.duration, delete h.duration)), g.to(t[d], e, h, d * o);
                        return this.add(g, s)
                        ...
                        if ("number" != typeof o && (o = this._parseTimeOrLabel(o, 0, !0, r)), !(r instanceof t)) {
                            if (r instanceof Array || r && r.push && l(r)) {
                                for (s = s || "normal", a = a || 0, u = o, c = r.length, h = 0; c > h; h++) l(f = r[h]) && (f = new n({
                                    tweens: f
                        ...
                        var n, o, s, a, l, h, f, p = this._dirty ? this.totalDuration() : this._totalDuration,
                            d = this._time,
                            m = this._startTime,
                            g = this._timeScale,
                            v = this._paused;
                        ...
                        if (this._time !== d && this._first || i || l || h) {
                            ...
                            this._onUpdate && (e || (u.length && c(), this._callback("onUpdate"))), a && (this._gc || (m === this._startTime || g !== this._timeScale) && (0 === this._time || p >= this.totalDuration()) && (o && (u.length && c(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[a] && this._callback(a)))
                        }
                    ...
                    return c.constructor = n, c.kill()._gc = !1, n.version = "1.19.0", c.invalidate = function() {
                        ...
                        this._gc && this._enabled(!0, !1);
                        var n, o, l, u, c, h, f, p, d = this._dirty ? this.totalDuration() : this._totalDuration,
                            m = this._duration,
                            g = this._time,
                            v = this._totalTime,
                            y = this._startTime,
                            ...
                            w = this._paused,
                            T = this._cycle;
                        if (t >= d - 1e-7) this._locked || (this._totalTime = d, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (o = !0, u = "onComplete", c = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= t && t >= -1e-7 || 0 > x || x === r) && x !== t && this._first && (c = !0, x > r && (u = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r, this._yoyo && 0 !== (1 & this._cycle) ? this._time = t = 0 : (this._time = m, t = m + 1e-4);
                        else if (1e-7 > t)
                            if (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== g || 0 === m && x !== r && (x > 0 || 0 > t && x >= 0) && !this._locked) && (u = "onReverseComplete", o = this._reversed), 0 > t) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (c = o = !0, u = "onReverseComplete") : x >= 0 && this._first && (c = !0), this._rawPrevTime = t;
                            else {
                                if (this._rawPrevTime = m || !e || t || this._rawPrevTime === t ? t : r, 0 === t && o)
                                    for (n = this._first; n && 0 === n._startTime;) n._duration || (o = !1), n = n._next;
                                t = 0, this._initted || (c = !0)
                            }
                        else if (0 === m && 0 > x && (c = !0), this._time = this._rawPrevTime = t, this._locked || (this._totalTime = t, 0 !== this._repeat && (h = m + this._repeatDelay, this._cycle = this._totalTime / h >> 0, 0 !== this._cycle && this._cycle === this._totalTime / h && t >= v && this._cycle--, this._time = this._totalTime - this._cycle * h, this._yoyo && 0 !== (1 & this._cycle) && (this._time = m - this._time), this._time > m ? (this._time = m, t = m + 1e-4) : this._time < 0 ? this._time = t = 0 : t = this._time)), this._hasPause && !this._forcingPlayhead && !e) {
                            if (t = this._time, t >= g)
                        ...
                        if (this._cycle !== T && !this._locked) {
                            var b = this._yoyo && 0 !== (1 & T),
                                ...
                                E = this._rawPrevTime,
                                O = this._time;
                            if (this._totalTime = T * m, this._cycle < T ? b = !b : this._totalTime += m, this._time = g, this._rawPrevTime = 0 === m ? x - 1e-4 : x, this._cycle = T, this._locked = !0, g = b ? 0 : m, this.render(g, e, 0 === m), e || this._gc || this.vars.onRepeat && this._callback("onRepeat"), g !== this._time) return;
                            if (S && (g = b ? m + 1e-4 : -1e-4, this.render(g, !0, !1)), this._locked = !1, this._paused && !w) return;
                            this._time = O, this._totalTime = C, this._cycle = k, this._rawPrevTime = E
                        }
                        ...
                        this._onUpdate && (e || (s.length && a(), this._callback("onUpdate"))), u && (this._locked || this._gc || (y === this._startTime || _ !== this._timeScale) && (0 === this._time || d >= this.totalDuration()) && (o && (s.length && a(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[u] && this._callback(u)))
                ...
                function() {
                    var t = 180 / Math.PI,
                        ...
                        u = function(t, r, o, s, a) {
                            var u, c, h, f, p, d, m, g, v, y, _, x, w, T = t.length - 1,
                                b = 0,
                                S = t[0].a;
                            for (u = 0; T > u; u++) p = t[b], c = p.a, h = p.d, f = t[b + 1].d, a ? (_ = e[u], x = i[u], w = (x + _) * r * .25 / (s ? .5 : n[u] || .5), d = h - (h - c) * (s ? .5 * r : 0 !== _ ? w / _ : 0), m = h + (f - h) * (s ? .5 * r : 0 !== x ? w / x : 0), g = h - (d + ((m - d) * (3 * _ / (_ + x) + .5) / 4 || 0))) : (d = h - (h - c) * r * .5, m = h + (f - h) * r * .5, g = h - (d + m) / 2), d += g, m += g, p.c = v = d, 0 !== u ? p.b = S : p.b = S = p.a + .6 * (p.c - p.a), p.da = h - c, p.ca = v - c, p.ba = S - c, o ? (y = l(c, S, v, h), t.splice(b, 1, y[0], y[1], y[2], y[3]), b += 4) : b++, S = m;
                            p = t[b], p.b = S, p.c = S + .4 * (p.d - S), p.da = p.d - p.a, p.ca = p.c - p.a, p.ba = S - p.a, o && (y = l(p.a, S, p.c, p.d), t.splice(b, 1, y[0], y[1], y[2], y[3]))
                        },
                        c = function(t, n, r, o) {
                            var a, l, u, c, h, f, p = [];
                            if (o)
                            ...
                            for (l = 0; a > l; l++) u = t[l][n], c = t[l + 1][n], p[l] = new s(u, 0, 0, c), r && (h = t[l + 2][n], e[l] = (e[l] || 0) + (c - u) * (c - u), i[l] = (i[l] || 0) + (h - c) * (h - c));
                            return p[l] = new s(t[l][n], 0, 0, t[l + 1][n]), p
                        },
                        h = function(t, o, s, l, h, f) {
                            var p, d, m, g, v, y, _, x, w = {},
                                T = [],
                                b = f || t[0];
                            h = "string" == typeof h ? "," + h + "," : a, null == o && (o = 1);
                            for (d in t[0]) T.push(d);
                            if (t.length > 1) {
                                for (x = t[t.length - 1], _ = !0, p = T.length; --p > -1;)
                                    if (d = T[p], Math.abs(b[d] - x[d]) > .05) {
                                        _ = !1;
                                        break
                                    } _ && (t = t.concat(), f && t.unshift(f), t.push(t[1]), f = t[t.length - 3])
                            }
                            for (e.length = i.length = n.length = 0, p = T.length; --p > -1;) d = T[p], r[d] = -1 !== h.indexOf("," + d + ","), w[d] = c(t, d, r[d], f);
                            for (p = e.length; --p > -1;) e[p] = Math.sqrt(e[p]), i[p] = Math.sqrt(i[p]);
                            if (!l) {
                                for (p = T.length; --p > -1;)
                                    if (r[d])
                                        for (m = w[T[p]], y = m.length - 1, g = 0; y > g; g++) v = m[g + 1].da / i[g] + m[g].da / e[g] || 0, n[g] = (n[g] || 0) + v * v;
                                for (p = n.length; --p > -1;) n[p] = Math.sqrt(n[p])
                            }
                            for (p = T.length, g = s ? 4 : 1; --p > -1;) d = T[p], m = w[d], u(m, o, s, l, r[d]), _ && (m.splice(0, g), m.splice(m.length - g, g));
                            return w
                        },
                        f = function(t, e, i) {
                            e = e || "soft";
                            var n, r, o, a, l, u, c, h, f, p, d, m = {},
                                g = "cubic" === e ? 3 : 2,
                                v = "soft" === e,
                                y = [];
                            ...
                            for (u = y.length; --u > -1;) {
                                for (f = y[u], m[f] = l = [], p = 0, h = t.length, c = 0; h > c; c++) n = null == i ? t[c][f] : "string" == typeof(d = t[c][f]) && "=" === d.charAt(1) ? i[f] + Number(d.charAt(0) + d.substr(2)) : Number(d), v && c > 1 && h - 1 > c && (l[p++] = (n + l[p - 2]) / 2), l[p++] = n;
                                for (h = p - g + 1, p = 0, c = 0; h > c; c += g) n = l[c], r = l[c + 1], o = l[c + 2], a = 2 === g ? 0 : l[c + 3], l[p++] = d = 3 === g ? new s(n, r, o, a) : new s(n, (2 * r + n) / 3, (2 * r + o) / 3, o);
                                l.length = p
                            }
                            return m
                        },
                        p = function(t, e, i) {
                            for (var n, r, o, s, a, l, u, c, h, f, p, d = 1 / i, m = t.length; --m > -1;)
                                for (f = t[m], o = f.a, s = f.d - o, a = f.c - o, l = f.b - o, n = r = 0, c = 1; i >= c; c++) u = d * c, h = 1 - u, n = r - (r = (u * u * s + 3 * h * (u * a + h * l)) * u), p = m * i + c - 1, e[p] = (e[p] || 0) + n * n
                        },
                        d = function(t, e) {
                            e = e >> 0 || 6;
                            var i, n, r, o, s = [],
                            ...
                            for (r = s.length, n = 0; r > n; n++) l += Math.sqrt(s[n]), o = n % e, f[o] = l, o === c && (u += l, o = n / e >> 0, h[o] = f, a[o] = u, l = 0, f = []);
                            return {
                                length: u,
                                lengths: a,
                                segments: h
                        ...
                        m = _gsScope._gsDefine.plugin({
                            ...
                            set: function(e) {
                                ...
                                if (this._autoRotate) {
                                    ...
                                    for (r = b.length; --r > -1;) o = b[r][2], w = b[r][3] || 0, T = b[r][4] === !0 ? 1 : t, s = this._beziers[b[r][0]], g = this._beziers[b[r][1]], s && g && (s = s[i], g = g[i], v = s.a + (s.b - s.a) * a, _ = s.b + (s.c - s.b) * a, v += (_ - v) * a, _ += (s.c + (s.d - s.c) * a - _) * a, y = g.a + (g.b - g.a) * a, x = g.b + (g.c - g.b) * a, y += (x - y) * a, x += (g.c + (g.d - g.c) * a - x) * a, l = m ? Math.atan2(x - y, _ - v) * T + w : this._initialRotations[r], this._mod[o] && (l = this._mod[o](l, d)), p[o] ? d[o](l) : d[o] = l)
                                }
                            }
                        }),
                        g = m.prototype;
                            ...
                            e._registerComplexSpecialProp("bezier", {
                                parser: function(t, e, o, s, a, l) {
                                    ...
                                    var u, c, h, f = e.values,
                                        ...
                                        g = {};
                                    if (0 > p) return a;
                                    for (u = 0; p >= u; u++) h = i(t, f[u], s, a, l, p !== u), d[u] = h.end;
                                    for (c in e) g[c] = e[c];
                    ...
                    var c, h, f, p, d, m, g, v, y = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                        ...
                        Y = function() {
                            var t = X.indexOf("Android"),
                                e = q("a");
                            return f = -1 !== X.indexOf("Safari") && -1 === X.indexOf("Chrome") && (-1 === t || Number(X.substr(t + 8, 1)) > 3), d = f && Number(X.substr(X.indexOf("Version/") + 8, 1)) < 6, p = -1 !== X.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(X) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(X)) && (m = parseFloat(RegExp.$1)), !!e && (e.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(e.style.opacity))
                        }(),
                        U = function(t) {
                        ...
                        $ = s.getStyle = function(t, e, i, n, r) {
                            var o;
                            return Y || "opacity" !== e ? (!n && t.style[e] ? o = t.style[e] : (i = i || J(t)) ? o = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(E, "-$1").toLowerCase()) : t.currentStyle && (o = t.currentStyle[e]), null == r || o && "none" !== o && "auto" !== o && "auto auto" !== o ? o : r) : U(t)
                        },
                        K = H.convertToPixels = function(t, i, n, r, o) {
                            ...
                            if (p && (n = -n), d && (n *= 100), "%" === r && -1 !== i.indexOf("border")) a = n / 100 * (c ? t.clientWidth : t.clientHeight);
                                ...
                                if (f.cssText = "border:0 solid red;position:" + $(t, "position") + ";line-height:0;", "%" !== r && h.appendChild && "v" !== r.charAt(0) && "rem" !== r) f[c ? "borderLeftWidth" : "borderTopWidth"] = n + r;
                                else {
                                    if (h = t.parentNode || j.body, l = h._gsCache, u = e.ticker.frame, l && c && l.time === u) return l.width * n / 100;
                                    f[c ? "width" : "height"] = n + r
                                }
                                h.appendChild(W), a = parseFloat(W[c ? "offsetWidth" : "offsetHeight"]), h.removeChild(W), c && "%" === r && s.cacheWidths !== !1 && (l = h._gsCache = h._gsCache || {}, l.time = u, l.width = a / n * 100), 0 !== a || o || (a = K(t, i, n, r, !0))
                            }
                        ...
                        et = function(t, e) {
                            ...
                            if (e = e || J(t, null))
                                if (i = e.length)
                                    for (; --i > -1;) r = e[i], (-1 === r.indexOf("-transform") || Ot === r) && (o[r.replace(O, M)] = e.getPropertyValue(r));
                                else
                                    for (i in e)(-1 === i.indexOf("Transform") || Et === i) && (o[i] = e[i]);
                            else if (e = t.currentStyle || t.style)
                                for (i in e) "string" == typeof i && void 0 === o[i] && (o[i.replace(O, M)] = e[i]);
                            return Y || (o.opacity = U(t)), n = $t(t, e, !1), o.rotation = n.rotation, o.skewX = n.skewX, o.scaleX = n.scaleX, o.scaleY = n.scaleY, o.x = n.x, o.y = n.y, Mt && (o.z = n.z, o.rotationX = n.rotationX, o.rotationY = n.rotationY, o.scaleZ = n.scaleZ), o.filters && delete o.filters, o
                        },
                        ...
                        ot = function(t, e, i) {
                            ...
                            var n = parseFloat("width" === e ? t.offsetWidth : t.offsetHeight),
                                r = nt[e],
                                o = r.length;
                            for (i = i || J(t, null); --o > -1;) n -= parseFloat($(t, "padding" + r[o], i, !0)) || 0, n -= parseFloat($(t, "border" + r[o] + "Width", i, !0)) || 0;
                            return n
                        },
                        st = function(t, e) {
                        ...
                        ft = s.parseColor = function(t, e) {
                            ...
                            return e && !f && (n = i[0] / 255, r = i[1] / 255, o = i[2] / 255, u = Math.max(n, r, o), c = Math.min(n, r, o), l = (u + c) / 2, u === c ? s = a = 0 : (h = u - c, a = l > .5 ? h / (2 - u - c) : h / (u + c), s = u === n ? (r - o) / h + (o > r ? 6 : 0) : u === r ? (o - n) / h + 2 : (n - r) / h + 4, s *= 60), i[0] = s + .5 | 0, i[1] = 100 * a + .5 | 0, i[2] = 100 * l + .5 | 0), i
                        },
                        pt = function(t, e) {
                    ...
                    var mt = function(t, e, i, n) {
                            ...
                            return c ? r = e ? function(t) {
                                ...
                                if (e = (t.match(dt) || [o])[0], f = t.split(e).join("").match(x) || [], p = f.length, c > p--)
                                ...
                                if ("number" == typeof t) t += h;
                                    ...
                                    for (o = t.replace(I, "|").split("|"), f = 0; f < o.length; f++) o[f] = r(o[f]);
                                    return o.join(",")
                                }
                        ...
                        yt = (H._parseToProxy = function(t, e, i, n, r, o) {
                            var s, a, l, u, c, h = n,
                                ...
                                d = i._transform,
                                m = z;
                            for (i._transform = null, z = e, n = c = i.parse(t, e, n, r), z = m, o && (i._transform = d, h && (h._prev = null, h._prev && (h._prev._next = null))); n && n !== h;) {
                                if (n.type <= 1 && (a = n.p, p[a] = n.s + n.c, f[a] = n.s, o || (u = new vt(n, "s", a, u, n.r), n.c = 0), 1 === n.type))
                                    for (s = n.l; --s > 0;) l = "xn" + s, a = n.p + "_" + l, p[a] = n.data[l], f[a] = n[l], o || (u = new vt(n, l, a, u, n.rxp[l]));
                                n = n._next
                            }
                            return {
                                proxy: f,
                            ...
                            this.t = t, this.p = e, this.s = n, this.c = r, this.n = l || e, t instanceof yt || o.push(this.n), this.r = u, this.type = a || 0, c && (this.pr = c, i = !0), this.b = void 0 === h ? n : h, this.e = void 0 === f ? n + r : f, s && (this._next = s, s._prev = this)
                        }),
                        ...
                        xt = s.parseComplex = function(t, e, i, n, r, o, a, l, u, h) {
                            i = i || o || "", "function" == typeof n && (n = n(v, g)), a = new yt(t, e, 0, 0, a, h ? 2 : 1, null, !1, l, i, n), n += "", r && dt.test(n + i) && (n = [i, n], s.colorStringFilter(n), i = n[0], n = n[1]);
                            var f, p, d, m, x, w, T, b, S, C, k, E, O, P = i.split(", ").join(",").split(" "),
                                M = n.split(", ").join(",").split(" "),
                                A = P.length,
                                L = c !== !1;
                            for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (P = P.join(" ").replace(I, ", ").split(" "), M = M.join(" ").replace(I, ", ").split(" "), A = P.length), A !== M.length && (P = (o || "").split(" "), A = P.length), a.plugin = u, a.setRatio = h, dt.lastIndex = 0, f = 0; A > f; f++)
                                if (m = P[f], x = M[f], b = parseFloat(m), b || 0 === b) a.appendXtra("", b, at(x, b), x.replace(_, ""), L && -1 !== x.indexOf("px"), !0);
                                else if (r && dt.test(m)) E = x.indexOf(")") + 1, E = ")" + (E ? x.substr(E) : ""), O = -1 !== x.indexOf("hsl") && Y, m = ft(m, O), x = ft(x, O), S = m.length + x.length > 6, S && !Y && 0 === x[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent", a.e = a.e.split(M[f]).join("transparent")) : (Y || (S = !1), O ? a.appendXtra(S ? "hsla(" : "hsl(", m[0], at(x[0], m[0]), ",", !1, !0).appendXtra("", m[1], at(x[1], m[1]), "%,", !1).appendXtra("", m[2], at(x[2], m[2]), S ? "%," : "%" + E, !1) : a.appendXtra(S ? "rgba(" : "rgb(", m[0], x[0] - m[0], ",", !0, !0).appendXtra("", m[1], x[1] - m[1], ",", !0).appendXtra("", m[2], x[2] - m[2], S ? "," : E, !0), S && (m = m.length < 4 ? 1 : m[3], a.appendXtra("", m, (x.length < 4 ? 1 : x[3]) - m, E, !1))), dt.lastIndex = 0;
                            else if (w = m.match(y)) {
                                if (T = x.match(_), !T || T.length !== w.length) return a;
                                for (d = 0, p = 0; p < w.length; p++) k = w[p], C = m.indexOf(k, d), a.appendXtra(m.substr(d, C - d), Number(k), at(T[p], k), "", L && "px" === m.substr(C + k.length, 2), 0 === p), d = C + k.length;
                                a["xs" + a.l] += m.substr(d)
                            ...
                            if (!l[t]) {
                                ...
                                bt(t, {
                                    parser: function(t, i, n, r, o, s, u) {
                                        ...
                                        return c ? (c._cssRegister(), l[n].parse(t, i, n, r, o, s, u)) : (V("Error: " + e + " js file not loaded."), o)
                                    }
                                })
                            }
                        };
                    u = Tt.prototype, u.parseComplex = function(t, e, i, n, r, o) {
                        ...
                        if (this.multi && (I.test(i) || I.test(e) ? (a = e.replace(I, "|").split("|"), l = i.replace(I, "|").split("|")) : f && (a = [e], l = [i])), l) {
                            for (u = l.length > a.length ? l.length : a.length, s = 0; u > s; s++) e = a[s] = a[s] || this.dflt, i = l[s] = l[s] || this.dflt, f && (c = e.indexOf(f), h = i.indexOf(f), c !== h && (-1 === h ? a[s] = a[s].split(f).join("") : -1 === c && (a[s] += " " + f)));
                            e = a.join(", "), i = l.join(", ")
                        }
                    ...
                    var Ct, kt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                        ...
                        Rt = function() {
                            ...
                            return j.createElementNS && !n && (t = Dt("svg", It), e = Dt("rect", t, {
                                width: 100,
                                height: 50,
                                x: 100
                            }), i = e.getBoundingClientRect().width, e.style[Pt] = "50% 50%", e.style[Et] = "scaleX(0.5)", n = i === e.getBoundingClientRect().width && !(p && Mt), It.removeChild(t)), n
                        }(),
                        Nt = function(t, e, i, n, r, o) {
                            var a, l, u, c, h, f, p, d, m, g, v, y, _, x, w = t._gsTransform,
                                T = qt(t, !0);
                            w && (_ = w.xOrigin, x = w.yOrigin), (!n || (a = n.split(" ")).length < 2) && (p = t.getBBox(), e = st(e).split(" "), a = [(-1 !== e[0].indexOf("%") ? parseFloat(e[0]) / 100 * p.width : parseFloat(e[0])) + p.x, (-1 !== e[1].indexOf("%") ? parseFloat(e[1]) / 100 * p.height : parseFloat(e[1])) + p.y]), i.xOrigin = c = parseFloat(a[0]), i.yOrigin = h = parseFloat(a[1]), n && T !== jt && (f = T[0], p = T[1], d = T[2], m = T[3], g = T[4], v = T[5], y = f * m - p * d, l = c * (m / y) + h * (-d / y) + (d * v - m * g) / y, u = c * (-p / y) + h * (f / y) - (f * v - p * g) / y, c = i.xOrigin = a[0] = l, h = i.yOrigin = a[1] = u), w && (o && (i.xOffset = w.xOffset, i.yOffset = w.yOffset, w = i), r || r !== !1 && s.defaultSmoothOrigin !== !1 ? (l = c - _, u = h - x, w.xOffset += l * T[0] + u * T[2] - l, w.yOffset += l * T[1] + u * T[3] - u) : w.xOffset = w.yOffset = 0), o || t.setAttribute("data-svg-origin", a.join(" "))
                        },
                        Ft = function(t) {
                            try {
                                return t.getBBox()
                        ...
                        qt = function(t, e) {
                            var i, n, r, o, s, a, l = t._gsTransform || new At,
                                u = 1e5,
                                c = t.style;
                            if (Et ? n = $(t, Ot, null, !0) : t.currentStyle && (n = t.currentStyle.filter.match(L), n = n && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), l.x || 0, l.y || 0].join(",") : ""), i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, i && Et && ((a = "none" === J(t).display) || !t.parentNode) && (a && (o = c.display, c.display = "block"), t.parentNode || (s = 1, It.appendChild(t)), n = $(t, Ot, null, !0), i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, o ? c.display = o : a && Xt(c, "display"), s && It.removeChild(t)), (l.svg || t.getBBox && zt(t)) && (i && -1 !== (c[Et] + "").indexOf("matrix") && (n = c[Et], i = 0), r = t.getAttribute("transform"), i && r && (-1 !== r.indexOf("matrix") ? (n = r, i = 0) : -1 !== r.indexOf("translate") && (n = "matrix(1,0,0,1," + r.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")", i = 0))), i) return jt;
                        ...
                        $t = H.getTransform = function(t, i, n, r) {
                            ...
                            var o, a, l, u, c, h, f = n ? t._gsTransform || new At : new At,
                                p = f.scaleX < 0,
                                d = 2e-5,
                                m = 1e5,
                                g = Mt ? parseFloat($(t, Pt, i, !1, "0 0 0").split(" ")[2]) || f.zOrigin || 0 : 0,
                                v = parseFloat(s.defaultTransformPerspective) || 0;
                            if (f.svg = !(!t.getBBox || !zt(t)), f.svg && (Nt(t, $(t, Pt, i, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")), Ct = s.useSVGTransformAttr || Rt), o = qt(t), o !== jt) {
                                if (16 === o.length) {
                                    var y, _, x, w, T, b = o[0],
                                        S = o[1],
                                        C = o[2],
                                        ...
                                        z = o[11],
                                        j = Math.atan2(P, D);
                                    f.zOrigin && (N = -f.zOrigin, I = A * N - o[12], R = L * N - o[13], N = D * N + f.zOrigin - o[14]), f.rotationX = j * F, j && (w = Math.cos(-j), T = Math.sin(-j), y = E * w + A * T, _ = O * w + L * T, x = P * w + D * T, A = E * -T + A * w, L = O * -T + L * w, D = P * -T + D * w, z = M * -T + z * w, E = y, O = _, P = x), j = Math.atan2(-C, D), f.rotationY = j * F, j && (w = Math.cos(-j), T = Math.sin(-j), y = b * w - A * T, _ = S * w - L * T, x = C * w - D * T, L = S * T + L * w, D = C * T + D * w, z = k * T + z * w, b = y, S = _, C = x), j = Math.atan2(S, b), f.rotation = j * F, j && (w = Math.cos(-j), T = Math.sin(-j), b = b * w + E * T, _ = S * w + O * T, O = S * -T + O * w, P = C * -T + P * w, S = _), f.rotationX && Math.abs(f.rotationX) + Math.abs(f.rotation) > 359.9 && (f.rotationX = f.rotation = 0, f.rotationY = 180 - f.rotationY), f.scaleX = (Math.sqrt(b * b + S * S) * m + .5 | 0) / m, f.scaleY = (Math.sqrt(O * O + L * L) * m + .5 | 0) / m, f.scaleZ = (Math.sqrt(P * P + D * D) * m + .5 | 0) / m, f.rotationX || f.rotationY ? f.skewX = 0 : (f.skewX = E || O ? Math.atan2(E, O) * F + f.rotation : f.skewX || 0, Math.abs(f.skewX) > 90 && Math.abs(f.skewX) < 270 && (p ? (f.scaleX *= -1, f.skewX += f.rotation <= 0 ? 180 : -180, f.rotation += f.rotation <= 0 ? 180 : -180) : (f.scaleY *= -1, f.skewX += f.skewX <= 0 ? 180 : -180))), f.perspective = z ? 1 / (0 > z ? -z : z) : 0, f.x = I, f.y = R, f.z = N, f.svg && (f.x -= f.xOrigin - (f.xOrigin * b - f.yOrigin * E), f.y -= f.yOrigin - (f.yOrigin * S - f.xOrigin * O))
                                    ...
                                    var q = o.length >= 6,
                                        ...
                                        H = o[2] || 0,
                                        X = q ? o[3] : 1;
                                    f.x = o[4] || 0, f.y = o[5] || 0, l = Math.sqrt(W * W + B * B), u = Math.sqrt(X * X + H * H), c = W || B ? Math.atan2(B, W) * F : f.rotation || 0, h = H || X ? Math.atan2(H, X) * F + c : f.skewX || 0, Math.abs(h) > 90 && Math.abs(h) < 270 && (p ? (l *= -1, h += 0 >= c ? 180 : -180, c += 0 >= c ? 180 : -180) : (u *= -1, h += 0 >= h ? 180 : -180)), f.scaleX = l, f.scaleY = u, f.rotation = c, f.skewX = h, Mt && (f.rotationX = f.rotationY = f.z = 0, f.perspective = v, f.scaleZ = 1), f.svg && (f.x -= f.xOrigin - (f.xOrigin * W + f.yOrigin * H), f.y -= f.yOrigin - (f.xOrigin * B + f.yOrigin * X))
                                }
                                f.zOrigin = g;
                        ...
                        Wt = function(t) {
                            ...
                            if (f) {
                                ...
                                if (null != n.ox && (p = (n.oxp ? g * n.ox * .01 : n.ox) - g / 2, d = (n.oyp ? v * n.oy * .01 : n.oy) - v / 2, x += p - (p * a + d * l), w += d - (p * u + d * c)), y ? (p = g / 2, d = v / 2, _ += ", Dx=" + (p - (p * a + d * l) + x) + ", Dy=" + (d - (p * u + d * c) + w) + ")") : _ += ", sizingMethod='auto expand')", -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? h.filter = e.replace(D, _) : h.filter = _ + " " + e, (0 === t || 1 === t) && 1 === a && 0 === l && 0 === u && 1 === c && (y && -1 === _.indexOf("Dx=0, Dy=0") || b.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && h.removeAttribute("filter")), !y) {
                                    var S, C, k, E = 8 > m ? 1 : -1;
                                    for (p = n.ieOffsetX || 0, d = n.ieOffsetY || 0, n.ieOffsetX = Math.round((g - ((0 > a ? -a : a) * g + (0 > l ? -l : l) * v)) / 2 + x), n.ieOffsetY = Math.round((v - ((0 > c ? -c : c) * v + (0 > u ? -u : u) * g)) / 2 + w), wt = 0; 4 > wt; wt++) C = rt[wt], S = f[C], i = -1 !== S.indexOf("px") ? parseFloat(S) : K(this.t, C, parseFloat(S), S.replace(T, "")) || 0, k = i !== n[C] ? 2 > wt ? -n.ieOffsetX : -n.ieOffsetY : 2 > wt ? p - n.ieOffsetX : d - n.ieOffsetY, h[C] = (n[C] = Math.round(i - k * (0 === wt || 2 === wt ? 1 : E))) + "px"
                                }
                            }
                        },
                        Bt = H.set3DTransformRatio = H.setTransformRatio = function(t) {
                            var e, i, n, r, o, s, a, l, u, c, h, f, d, m, g, v, y, _, x, w, T, b, S, C = this.data,
                                k = this.t.style,
                                E = C.rotation,
                                O = C.rotationX,
                                P = C.rotationY,
                                ...
                                z = C.perspective,
                                j = C.force3D;
                            if (((1 === t || 0 === t) && "auto" === j && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime) || !j) && !R && !z && !P && !O && 1 === L || Ct && F || !Mt) return void(E || C.skewX || F ? (E *= N, b = C.skewX * N, S = 1e5, e = Math.cos(E) * M, r = Math.sin(E) * M, i = Math.sin(E - b) * -A, o = Math.cos(E - b) * A, b && "simple" === C.skewType && (y = Math.tan(b - C.skewY * N), y = Math.sqrt(1 + y * y), i *= y, o *= y, C.skewY && (y = Math.tan(C.skewY * N), y = Math.sqrt(1 + y * y), e *= y, r *= y)), F && (D += C.xOrigin - (C.xOrigin * e + C.yOrigin * i) + C.xOffset, I += C.yOrigin - (C.xOrigin * r + C.yOrigin * o) + C.yOffset, Ct && (C.xPercent || C.yPercent) && (m = this.t.getBBox(), D += .01 * C.xPercent * m.width, I += .01 * C.yPercent * m.height), m = 1e-6, m > D && D > -m && (D = 0), m > I && I > -m && (I = 0)), x = (e * S | 0) / S + "," + (r * S | 0) / S + "," + (i * S | 0) / S + "," + (o * S | 0) / S + "," + D + "," + I + ")", F && Ct ? this.t.setAttribute("transform", "matrix(" + x) : k[Et] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix(" : "matrix(") + x) : k[Et] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix(" : "matrix(") + M + ",0,0," + A + "," + D + "," + I + ")");
                            if (p && (m = 1e-4, m > M && M > -m && (M = L = 2e-5), m > A && A > -m && (A = L = 2e-5), !z || C.z || C.rotationX || C.rotationY || (z = 0)), E || C.skewX) E *= N, g = e = Math.cos(E), v = r = Math.sin(E), C.skewX && (E -= C.skewX * N, g = Math.cos(E), v = Math.sin(E), "simple" === C.skewType && (y = Math.tan((C.skewX - C.skewY) * N), y = Math.sqrt(1 + y * y), g *= y, v *= y, C.skewY && (y = Math.tan(C.skewY * N), y = Math.sqrt(1 + y * y), e *= y, r *= y))), i = -v, o = g;
                            else {
                                if (!(P || O || 1 !== L || z || F)) return void(k[Et] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) translate3d(" : "translate3d(") + D + "px," + I + "px," + R + "px)" + (1 !== M || 1 !== A ? " scale(" + M + "," + A + ")" : ""));
                                e = o = 1, i = r = 0
                            }
                            u = 1, n = s = a = l = c = h = 0, f = z ? -1 / z : 0, d = C.zOrigin, m = 1e-6, w = ",", T = "0", E = P * N, E && (g = Math.cos(E), v = Math.sin(E), a = -v, c = f * -v, n = e * v, s = r * v, u = g, f *= g, e *= g, r *= g), E = O * N, E && (g = Math.cos(E), v = Math.sin(E), y = i * g + n * v, _ = o * g + s * v, l = u * v, h = f * v, n = i * -v + n * g, s = o * -v + s * g, u *= g, f *= g, i = y, o = _), 1 !== L && (n *= L, s *= L, u *= L, f *= L), 1 !== A && (i *= A, o *= A, l *= A, h *= A), 1 !== M && (e *= M, r *= M, a *= M, c *= M), (d || F) && (d && (D += n * -d, I += s * -d, R += u * -d + d), F && (D += C.xOrigin - (C.xOrigin * e + C.yOrigin * i) + C.xOffset, I += C.yOrigin - (C.xOrigin * r + C.yOrigin * o) + C.yOffset), m > D && D > -m && (D = T), m > I && I > -m && (I = T), m > R && R > -m && (R = 0)), x = C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix3d(" : "matrix3d(", x += (m > e && e > -m ? T : e) + w + (m > r && r > -m ? T : r) + w + (m > a && a > -m ? T : a), x += w + (m > c && c > -m ? T : c) + w + (m > i && i > -m ? T : i) + w + (m > o && o > -m ? T : o), O || P || 1 !== L ? (x += w + (m > l && l > -m ? T : l) + w + (m > h && h > -m ? T : h) + w + (m > n && n > -m ? T : n), x += w + (m > s && s > -m ? T : s) + w + (m > u && u > -m ? T : u) + w + (m > f && f > -m ? T : f) + w) : x += ",0,0,0,0,1,0,", x += D + w + I + w + R + w + (z ? 1 + -R / z : 1) + ")", k[Et] = x
                        };
                    u = At.prototype, u.x = u.y = u.z = u.skewX = u.skewY = u.rotation = u.rotationX = u.rotationY = u.zOrigin = u.xPercent = u.yPercent = u.xOffset = u.yOffset = 0, u.scaleX = u.scaleY = u.scaleZ = 1, bt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                        parser: function(t, e, i, n, o, a, l) {
                            ...
                            var c, h, f, p, d, m, y, _, x, w = t._gsTransform,
                                T = t.style,
                                b = 1e-6,
                                S = kt.length,
                                C = l,
                                k = {},
                                E = "transformOrigin",
                                O = $t(t, r, !0, C.parseTransform),
                                P = C.transform && ("function" == typeof C.transform ? C.transform(v, g) : C.transform);
                            if (n._transform = O, P && "string" == typeof P && Et) h = W.style, h[Et] = P, h.display = "block", h.position = "absolute", j.body.appendChild(W), c = $t(W, null, !1), O.svg && (m = O.xOrigin, y = O.yOrigin, c.x -= O.xOffset, c.y -= O.yOffset, (C.transformOrigin || C.svgOrigin) && (P = {}, Nt(t, st(C.transformOrigin), P, C.svgOrigin, C.smoothOrigin, !0), m = P.xOrigin, y = P.yOrigin, c.x -= P.xOffset - O.xOffset, c.y -= P.yOffset - O.yOffset), (m || y) && (_ = qt(W, !0), c.x -= m - (m * _[0] + y * _[2]), c.y -= y - (m * _[1] + y * _[3]))), j.body.removeChild(W), c.perspective || (c.perspective = O.perspective), null != C.xPercent && (c.xPercent = lt(C.xPercent, O.xPercent)), null != C.yPercent && (c.yPercent = lt(C.yPercent, O.yPercent));
                                ...
                                "string" == typeof C.x && -1 !== C.x.indexOf("%") && (c.x = 0, c.xPercent = lt(C.x, O.xPercent)), "string" == typeof C.y && -1 !== C.y.indexOf("%") && (c.y = 0, c.yPercent = lt(C.y, O.yPercent)), c.rotation = ut("rotation" in C ? C.rotation : "shortRotation" in C ? C.shortRotation + "_short" : "rotationZ" in C ? C.rotationZ : O.rotation - O.skewY, O.rotation - O.skewY, "rotation", k), Mt && (c.rotationX = ut("rotationX" in C ? C.rotationX : "shortRotationX" in C ? C.shortRotationX + "_short" : O.rotationX || 0, O.rotationX, "rotationX", k), c.rotationY = ut("rotationY" in C ? C.rotationY : "shortRotationY" in C ? C.shortRotationY + "_short" : O.rotationY || 0, O.rotationY, "rotationY", k)), c.skewX = ut(C.skewX, O.skewX - O.skewY), (c.skewY = ut(C.skewY, O.skewY)) && (c.skewX += c.skewY, c.rotation += c.skewY)
                            }
                            for (Mt && null != C.force3D && (O.force3D = C.force3D, p = !0), O.skewType = C.skewType || O.skewType || s.defaultSkewType, f = O.force3D || O.z || O.rotationX || O.rotationY || c.z || c.rotationX || c.rotationY || c.perspective, f || null == C.scale || (c.scaleZ = 1); --S > -1;) x = kt[S], P = c[x] - O[x], (P > b || -b > P || null != C[x] || null != z[x]) && (p = !0,
                                o = new yt(O, x, O[x], P, o), x in k && (o.e = k[x]), o.xs0 = 0, o.plugin = a, n._overwriteProps.push(o.n));
                            return P = C.transformOrigin, O.svg && (P || C.svgOrigin) && (m = O.xOffset, y = O.yOffset, Nt(t, st(P), c, C.svgOrigin, C.smoothOrigin), o = _t(O, "xOrigin", (w ? O : c).xOrigin, c.xOrigin, o, E), o = _t(O, "yOrigin", (w ? O : c).yOrigin, c.yOrigin, o, E), (m !== O.xOffset || y !== O.yOffset) && (o = _t(O, "xOffset", w ? m : O.xOffset, O.xOffset, o, E), o = _t(O, "yOffset", w ? y : O.yOffset, O.yOffset, o, E)), P = Ct ? null : "0px 0px"), (P || Mt && f && O.zOrigin) && (Et ? (p = !0, x = Pt, P = (P || $(t, x, r, !1, "50% 50%")) + "", o = new yt(T, x, 0, 0, o, -1, E), o.b = T[x], o.plugin = a, Mt ? (h = O.zOrigin, P = P.split(" "), O.zOrigin = (P.length > 2 && (0 === h || "0px" !== P[2]) ? parseFloat(P[2]) : h) || 0, o.xs0 = o.e = P[0] + " " + (P[1] || "50%") + " 0px", o = new yt(O, "zOrigin", 0, 0, o, -1, o.n), o.b = h, o.xs0 = o.e = O.zOrigin) : o.xs0 = o.e = P) : st(P + "", O)), p && (n._transformType = O.svg && Ct || !f && 3 !== this._transformType ? 2 : 3), u && (l[i] = u), o
                        },
                        prefix: !0
                    }), bt("boxShadow", {
                        ...
                        parser: function(t, e, i, o, s, a) {
                            e = this.format(e);
                            var l, u, c, h, f, p, d, m, g, v, y, _, x, w, T, b, S = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                                C = t.style;
                            for (g = parseFloat(t.offsetWidth), v = parseFloat(t.offsetHeight), l = e.split(" "), u = 0; u < S.length; u++) this.p.indexOf("border") && (S[u] = Z(S[u])), f = h = $(t, S[u], r, !1, "0px"), -1 !== f.indexOf(" ") && (h = f.split(" "), f = h[0], h = h[1]), p = c = l[u], d = parseFloat(f), _ = f.substr((d + "").length), x = "=" === p.charAt(1), x ? (m = parseInt(p.charAt(0) + "1", 10), p = p.substr(2), m *= parseFloat(p), y = p.substr((m + "").length - (0 > m ? 1 : 0)) || "") : (m = parseFloat(p), y = p.substr((m + "").length)), "" === y && (y = n[i] || _), y !== _ && (w = K(t, "borderLeft", d, _), T = K(t, "borderTop", d, _), "%" === y ? (f = w / g * 100 + "%", h = T / v * 100 + "%") : "em" === y ? (b = K(t, "borderLeft", 1, "em"), f = w / b + "em", h = T / b + "em") : (f = w + "px", h = T + "px"), x && (p = parseFloat(f) + m + y, c = parseFloat(h) + m + y)), s = xt(C, S[u], f + " " + h, p + " " + c, !1, "0px", s);
                            return s
                        },
                        prefix: !0,
                        ...
                        parser: function(t, e, i, n, o, s) {
                            var a, l, u, c, h, f, p = "background-position",
                                ...
                                v = this.format(e);
                            if (-1 !== g.indexOf("%") != (-1 !== v.indexOf("%")) && v.split(",").length < 2 && (f = $(t, "backgroundImage").replace(P, ""), f && "none" !== f)) {
                                for (a = g.split(" "), l = v.split(" "), B.setAttribute("src", f), u = 2; --u > -1;) g = a[u], c = -1 !== g.indexOf("%"), c !== (-1 !== l[u].indexOf("%")) && (h = 0 === u ? t.offsetWidth - B.width : t.offsetHeight - B.height, a[u] = c ? parseFloat(g) / 100 * h + "px" : parseFloat(g) / h * 100 + "%");
                                g = a.join(" ")
                            }
                        ...
                        parser: function(t, e, i, n, o, s) {
                            var a, l, u;
                            return 9 > m ? (l = t.currentStyle, u = 8 > m ? " " : ",", a = "rect(" + l.clipTop + u + l.clipRight + u + l.clipBottom + u + l.clipLeft + ")", e = this.format(e).split(",").join(u)) : (a = this.format($(t, this.p, r, !1, this.dflt)), e = this.format(e)), this.parseComplex(t.style, a, e, o, s)
                        }
                    }), bt("textShadow", {
                        ...
                        parser: function(t, e, i, n, o, s) {
                            var a = $(t, "borderTopWidth", r, !1, "0px"),
                                ...
                                u = l[0].replace(T, "");
                            return "px" !== u && (a = parseFloat(a) / K(t, "borderTopWidth", 1, u) + u), this.parseComplex(t.style, this.format(a + " " + $(t, "borderTopStyle", r, !1, "solid") + " " + $(t, "borderTopColor", r, !1, "#000")), l.join(" "), o, s)
                        },
                        color: !0,
                        formatter: function(t) {
                            var e = t.split(" ");
                    ...
                    var Ht = function(t) {
                        var e, i = this.t,
                            ...
                            r = this.s + this.c * t | 0;
                        100 === r && (-1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (i.removeAttribute("filter"), e = !$(this.data, "filter")) : (i.filter = n.replace(C, ""), e = !0)), e || (this.xn1 && (i.filter = n = n || "alpha(opacity=" + r + ")"), -1 === n.indexOf("pacity") ? 0 === r && this.xn1 || (i.filter = n + " alpha(opacity=" + r + ")") : i.filter = n.replace(b, "opacity=" + r))
                    };
                    bt("opacity,alpha,autoAlpha", {
                        ...
                        parser: function(t, e, i, n, o, s) {
                            var a = parseFloat($(t, "opacity", r, !1, "1")),
                                l = t.style,
                                u = "autoAlpha" === i;
                            return "string" == typeof e && "=" === e.charAt(1) && (e = ("-" === e.charAt(0) ? -1 : 1) * parseFloat(e.substr(2)) + a), u && 1 === a && "hidden" === $(t, "visibility", r) && 0 !== e && (a = 0), Y ? o = new yt(l, "opacity", a, e - a, o) : (o = new yt(l, "opacity", 100 * a, 100 * (e - a), o), o.xn1 = u ? 1 : 0, l.zoom = 1, o.type = 2, o.b = "alpha(opacity=" + o.s + ")", o.e = "alpha(opacity=" + (o.s + o.c) + ")", o.data = t, o.plugin = s, o.setRatio = Ht), u && (o = new yt(l, "visibility", 0, 0, o, -1, null, !1, 0, 0 !== a ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit"), o.xs0 = "inherit", n._overwriteProps.push(o.n), n._overwriteProps.push(i)), o
                        }
                    });
                    var Xt = function(t, e) {
                    ...
                    bt("className", {
                        parser: function(t, e, n, o, s, a, l) {
                            var u, c, h, f, p, d = t.getAttribute("class") || "",
                                m = t.style.cssText;
                            if (s = o._classNamePT = new yt(t, n, 0, 0, s, 2), s.setRatio = Yt, s.pr = -11, i = !0, s.b = d, c = et(t, r), h = t._gsClassPT) {
                                for (f = {}, p = h.data; p;) f[p.p] = 1, p = p._next;
                                h.setRatio(1)
                            }
                            return t._gsClassPT = s, s.e = "=" !== e.charAt(1) ? e : d.replace(new RegExp("(?:\\s|^)" + e.substr(2) + "(?![\\w-])"), "") + ("+" === e.charAt(0) ? " " + e.substr(2) : ""), t.setAttribute("class", s.e), u = it(t, c, et(t), l, f), t.setAttribute("class", d), s.data = u.firstMPT, t.style.cssText = m, s = s.xfirst = o.parse(t, u.difs, s, a)
                        }
                    });
                    var Ut = function(t) {
                        if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                            ...
                            if ("all" === this.e) s.cssText = "", r = !0;
                                ...
                                for (e = this.e.split(" ").join("").split(","), n = e.length; --n > -1;) i = e[n], l[i] && (l[i].parse === a ? r = !0 : i = "transformOrigin" === i ? Pt : l[i].p), Xt(s, i);
                            r && (Xt(s, Et), o = this.t._gsTransform, o && (o.svg && (this.t.removeAttribute("data-svg-origin"), this.t.removeAttribute("transform")), delete this.t._gsTransform))
                        }
                    };
                    for (bt("clearProps", {
                            parser: function(t, e, n, r, o) {
                                return o = new yt(t, n, 0, 0, o, 2), o.setRatio = Ut, o.e = e, o.pr = -10, o.data = r._tween, i = !0, o
                            }
                    ...
                    u = s.prototype, u._firstPT = u._lastParsedTransform = u._transform = null, u._onInitTween = function(t, e, a, u) {
                        ...
                        this._target = g = t, this._tween = a, this._vars = e, v = u, c = e.autoRound, i = !1, n = e.suffixMap || s.suffixMap, r = J(t, ""), o = this._overwriteProps;
                        var p, m, y, _, x, w, T, b, C, k = t.style;
                        if (h && "" === k.zIndex && (p = $(t, "zIndex", r), ("auto" === p || "" === p) && this._addLazySet(k, "zIndex", 0)), "string" == typeof e && (_ = k.cssText, p = et(t, r), k.cssText = _ + ";" + e, p = it(t, p, et(t)).difs, !Y && S.test(e) && (p.opacity = parseFloat(RegExp.$1)), e = p, k.cssText = _), e.className ? this._firstPT = m = l.className.parse(t, e.className, "className", this, null, null, e) : this._firstPT = m = this.parse(t, e, null), this._transformType) {
                            for (C = 3 === this._transformType, Et ? f && (h = !0, "" === k.zIndex && (T = $(t, "zIndex", r), ("auto" === T || "" === T) && this._addLazySet(k, "zIndex", 0)), d && this._addLazySet(k, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (C ? "visible" : "hidden"))) : k.zoom = 1, y = m; y && y._next;) y = y._next;
                            b = new yt(t, "transform", 0, 0, null, 2), this._linkCSSP(b, null, y), b.setRatio = Et ? Bt : Wt, b.data = this._transform || $t(t, r, !0), b.tween = a, b.pr = -1, o.pop()
                        }
                        if (i) {
                            for (; m;) {
                        ...
                        for (s in e) p = e[s], "function" == typeof p && (p = p(v, g)), a = l[s], a ? i = a.parse(t, p, s, this, i, o, e) : (f = $(t, s, r) + "", y = "string" == typeof p, "color" === s || "fill" === s || "stroke" === s || -1 !== s.indexOf("Color") || y && k.test(p) ? (y || (p = ft(p), p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")"), i = xt(x, s, f, p, !0, "transparent", i, 0, o)) : y && R.test(p) ? i = xt(x, s, f, p, !0, null, i, 0, o) : (u = parseFloat(f), d = u || 0 === u ? f.substr((u + "").length) : "", ("" === f || "auto" === f) && ("width" === s || "height" === s ? (u = ot(t, s, r), d = "px") : "left" === s || "top" === s ? (u = tt(t, s, r), d = "px") : (u = "opacity" !== s ? 0 : 1, d = "")), _ = y && "=" === p.charAt(1), _ ? (h = parseInt(p.charAt(0) + "1", 10), p = p.substr(2), h *= parseFloat(p), m = p.replace(T, "")) : (h = parseFloat(p), m = y ? p.replace(T, "") : ""), "" === m && (m = s in n ? n[s] : d), p = h || 0 === h ? (_ ? h + u : h) + m : e[s], d !== m && "" !== m && (h || 0 === h) && u && (u = K(t, s, u, d), "%" === m ? (u /= K(t, s, 100, "%") / 100, e.strictUnits !== !0 && (f = u + "%")) : "em" === m || "rem" === m || "vw" === m || "vh" === m ? u /= K(t, s, 1, m) : "px" !== m && (h = K(t, s, h, m), m = "px"), _ && (h || 0 === h) && (p = h + u + m)), _ && (h += u), !u && 0 !== u || !h && 0 !== h ? void 0 !== x[s] && (p || p + "" != "NaN" && null != p) ? (i = new yt(x, s, h || u || 0, 0, i, -1, s, !1, 0, f, p), i.xs0 = "none" !== p || "display" !== s && -1 === s.indexOf("Style") ? p : f) : V("invalid " + s + " tween value: " + e[s]) : (i = new yt(x, s, u, h - u, i, 0, s, c !== !1 && ("px" === m || "zIndex" === s), 0, f, p), i.xs0 = m))), o && i && !i.plugin && (i.plugin = o);
                        return i
                        ...
                        this._transform = this._transform || $t(this._target, r, !0), this._transformType = this._transform.svg && Ct || !t && 3 !== this._transformType ? 2 : 3
                    };
                    var Vt = function(t) {
                    ...
                    return s.cascadeTo = function(t, i, n) {
                        ...
                        for (t = l._targets || l.target, Gt(t, c, f), l.render(i, !0, !0), Gt(t, h), l.render(0, !0, !0), l._enabled(!0), r = f.length; --r > -1;)
        ...
        function(t, e) {
            ...
            if (!n.TweenLite) {
                var r, o, s, a, l, u = function(t) {
                    ...
                    g = function(r, o, s, a) {
                        ...
                        this.check = function(c) {
                            for (var h, f, p, d, v, y = o.length, _ = y; --y > -1;)(h = m[o[y]] || new g(o[y], [])).gsClass ? (l[y] = h.gsClass, _--) : c && h.sc.push(this);
                            if (0 === _ && s) {
                                if (f = ("com.greensock." + r).split("."), p = f.pop(), d = u(f.join("."))[p] = this.gsClass = s.apply(s, l), a)
                                    if (n[p] = i[p] = d, v = "undefined" != typeof module && module.exports, !v && "function" == typeof define && define.amd) define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + r.split(".").pop(), [], function() {
                                        return d
                                    });
                                    else if (v)
                                    if (r === e) {
                ...
                var _ = [0, 0, 1, 1],
                    ...
                    T = x.register = function(t, e, i, n) {
                        for (var r, o, s, a, l = e.split(","), u = l.length, h = (i || "easeIn,easeOut,easeInOut").split(","); --u > -1;)
                            for (o = l[u], r = n ? y("easing." + o, null, !0) : c.easing[o] || {}, s = h.length; --s > -1;) a = h[s], w[o + "." + a] = w[a + o] = r[a] = t.getRatio ? t : t[a] || new t
                    };
                ...
                var S = t.requestAnimationFrame,
                    ...
                    E = k();
                for (r = ["ms", "moz", "webkit", "o"], o = r.length; --o > -1 && !S;) S = t[r[o] + "RequestAnimationFrame"], C = t[r[o] + "CancelAnimationFrame"] || t[r[o] + "CancelRequestAnimationFrame"];
                y("Ticker", function(t, e) {
                    var i, n, r, o, s, u = this,
                        ...
                        v = function(t) {
                            var e, a, l = k() - E;
                            l > d && (c += l - m), E += l, u.time = (E - c) / 1e3, e = u.time - s, (!i || e > 0 || t === !0) && (u.frame++, s += e + (e >= o ? .004 : o - e), a = !0), t !== !0 && (r = n(v)), a && u.dispatchEvent(g)
                        };
                    b.call(u), u.time = u.frame = 0, u.tick = function() {
                        ...
                        null != r && (f && C ? C(r) : clearTimeout(r), n = p, r = null, u === a && (l = !1))
                    }, u.wake = function(t) {
                        null !== r ? u.sleep() : t ? c += -E + (E = k()) : u.frame > 10 && (E = k() - d + 5), n = 0 === i ? p : f && S ? S : function(t) {
                ...
                var P = function() {
                    l && k() - E > 2e3 && a.wake(), setTimeout(P, 2e3)
                };
                ...
                s = M.prototype = new O, s.constructor = M, s.kill()._gc = !1, s._first = s._last = s._recent = null, s._sortChildren = !1, s.add = s.insert = function(t, e, i, n) {
                    var r, o;
                ...
                var A = y("TweenLite", function(e, i, n) {
                        ...
                        if (this._overwrite = l = null == l ? Y[A.defaultOverwrite] : "number" == typeof l ? l >> 0 : Y[l], (a || e instanceof Array || e.push && d(e)) && "number" != typeof e[0])
                    ...
                    D = function(t, e) {
                        var i, n = {};
                        for (i in t) X[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!W[i] || W[i] && W[i]._autoCSS) || (n[i] = t[i], delete t[i]);
                        t.css = n
                    };
                s = A.prototype = new O, s.constructor = A, s.kill()._gc = !1, s.ratio = 0, s._firstPT = s._targets = s._overwrittenProps = s._startAt = null, s._notifyPluginsOfEnabled = s._lazy = !1, A.version = "1.19.0", A.defaultEase = s._ease = new x(null, null, 1, 1), A.defaultOverwrite = "auto", A.ticker = a, A.autoSleep = 120, A.lagSmoothing = function(t, e) {
                    a.lagSmoothing(t, e)
                ...
                var I = [],
                    ...
                    z = function(t, e, i, n) {
                        var r, o, s, a, l, u, c, h = [t, e],
                            ...
                            p = "",
                            d = 0;
                        for (h.start = t, i && (i(h), t = h[0], e = h[1]), h.length = 0, r = t.match(N) || [], o = e.match(N) || [], n && (n._next = null, n.blob = 1, h._firstPT = h._applyPT = n), l = o.length, a = 0; l > a; a++) c = o[a], u = e.substr(f, e.indexOf(c, f) - f), p += u || !a ? u : ",", f += u.length, d ? d = (d + 1) % 5 : "rgba(" === u.substr(-5) && (d = 1), c === r[a] || r.length <= a ? p += c : (p && (h.push(p), p = ""), s = parseFloat(r[a]), h.push(s), h._firstPT = {
                            _next: h._firstPT,
                            t: h,
                            p: h.length - 1,
                            s: s,
                    ...
                    j = function(t, e, i, n, r, o, s, a, l) {
                        ...
                        return "number" !== f && ("function" === f && "get" === i && (c = e.indexOf("set") || "function" != typeof t["get" + e.substr(3)] ? e : "get" + e.substr(3), d.s = h = s ? t[c](s) : t[c]()), "string" == typeof h && (s || isNaN(h)) ? (d.fp = s, u = z(h, n, a || A.defaultStringFilter, d), d = {
                            t: u,
                            p: "setRatio",
                            s: 0,
                            c: 1,
                            ...
                            pr: 0,
                            m: 0
                        }) : p || (d.s = parseFloat(h), d.c = parseFloat(n) - d.s || 0)), d.c ? ((d._next = this._firstPT) && (d._next._prev = d), this._firstPT = d, d) : void 0
                    },
                    q = A._internals = {
                        isArray: d,
                        isSelector: L,
                    ...
                    Q = q.lazyRender = function() {
                        var t, e = I.length;
                        for (R = {}; --e > -1;) t = I[e], t && t._lazy !== !1 && (t.render(t._lazy[0], t._lazy[1], !0), t._lazy = !1);
                        I.length = 0
                    };
                V._startTime = a.time, U._startTime = a.frame, V._active = U._active = !0, setTimeout(Q, 1), O._updateRoot = A.render = function() {
                    var t, e, i;
                    if (I.length && Q(), V.render((a.time - V._startTime) * V._timeScale, !1, !1), U.render((a.frame - U._startTime) * U._timeScale, !1, !1), I.length && Q(), a.frame >= G) {
                        G = a.frame + (parseInt(A.autoSleep, 10) || 120);
                        for (i in B) {
                            for (e = B[i].tweens, t = e.length; --t > -1;) e[t]._gc && e.splice(t, 1);
                            0 === e.length && delete B[i]
                        }
                        if (i = V._first, (!i || i._paused) && A.autoSleep && !U._first && 1 === a._listeners.tick.length) {
                ...
                var Z = function(t, e, i) {
                    ...
                    J = function(t, e, i, n) {
                        ...
                        return s && (r = s(t, e, i, n)), s = A.onOverwrite, s && (o = s(t, e, i, n)), r !== !1 && o !== !1
                    },
                    $ = function(t, e, i, n, r) {
                        var o, s, a, l;
                        if (1 === n || n >= 4) {
                        ...
                        var u, c = e._startTime + h,
                            ...
                            p = 0,
                            d = 0 === e._duration;
                        for (o = r.length; --o > -1;)(a = r[o]) === e || a._gc || a._paused || (a._timeline !== e._timeline ? (u = u || K(e, 0, d), 0 === K(a, u, d) && (f[p++] = a)) : a._startTime <= c && a._startTime + a.totalDuration() / a._timeScale > c && ((d || !a._initted) && c - a._startTime <= 2e-10 || (f[p++] = a)));
                        for (o = p; --o > -1;)
                ...
                s._init = function() {
                    ...
                    var s, a, l, u, c, h;
                    if (null == e) return !1;
                    R[e._gsTweenID] && Q(), this.vars.css || e.style && e !== t && e.nodeType && W.css && this.vars.autoCSS !== !1 && D(this.vars, e);
                    for (s in this.vars)
                        if (h = this.vars[s], X[s]) h && (h instanceof Array || h.push && d(h)) && -1 !== h.join("").indexOf("{self}") && (this.vars[s] = h = this._swapSelfInParams(h, this));
                    ...
                    return r && this._kill(r, e) ? this._initProps(e, i, n, r, o) : this._overwrite > 1 && this._firstPT && n.length > 1 && $(e, this, i, this._overwrite, n) ? (this._kill(i, e), this._initProps(e, i, n, r, o)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (R[e._gsTweenID] = !0), l)
                }, s.render = function(t, e, i) {
                    ...
                    if (this._time !== a || i) {
                        if (!this._initted) {
                            if (this._init(), !this._initted || this._gc) return;
                            if (!i && this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration)) return this._time = this._totalTime = a, this._rawPrevTime = u, I.push(this), void(this._lazy = [t, e]);
                ...
                if (s = tt.prototype, tt.version = "1.19.0", tt.API = 2, s._firstPT = null, s._addTween = j, s.setRatio = F, s._kill = function(t) {
                        ...
                        for (var e = t.length; --e > -1;) t[e].API === tt.API && (W[(new t[e])._propName] = t[e]);
                        return !0
                    }, v.plugin = function(t) {
            ...
            t.Controller = function(n) {
                var o, s, a = "ScrollMagic.Controller",
                    ...
                    w = function() {
                        ...
                        y = p.container === window || p.container === document.body || !document.body.contains(p.container), y && (p.container = window), _ = S(), p.container.addEventListener("resize", O), p.container.addEventListener("scroll", O), p.refreshInterval = parseInt(p.refreshInterval) || h.refreshInterval, T()
                    },
                    T = function() {
                    ...
                    O = function(t) {
                        "resize" == t.type && (_ = S(), v = c), m !== !0 && (m = !0, E())
                    },
                    P = function() {
                        if (!y && _ != S()) {
                            var t;
                ...
                return this.addScene = function(e) {
                    ...
                    return r.type.Array(e) ? e.forEach(function(t) {
                        f.updateScene(t, i)
                    }) : i ? e.update(!0) : m !== !0 && e instanceof t.Scene && (m = m || [], -1 == m.indexOf(e) && m.push(e), m = M(m), E()), f
                }, this.update = function(t) {
                    return O({
                        type: "resize"
                    }), t && k(), f
                }, this.scrollTo = function(i, n) {
                    if (r.type.Number(i)) C.call(p.container, i, n);
            ...
            t.Controller.addOption = function(t, e) {
                ...
                this.on = function(t, e) {
                    ...
                    return e instanceof t.Controller && s != e && (s && s.removeScene(h), s = e, C(), w(!0), T(!0), x(), s.info("container").addEventListener("resize", b), e.addScene(h), h.trigger("add", {
                        controller: s
                    }), h.update()), h
                }, this.enabled = function(t) {
                    ...
                    if (arguments.length) {
                        var e = !1,
                            ...
                            r = f.reverse || t >= d;
                        if (0 === f.duration ? (e = d != t, d = 1 > t && r ? 0 : 1, p = 0 === d ? a : l) : 0 > t && p !== a && r ? (d = 0, p = a, e = !0) : t >= 0 && 1 > t && r ? (d = t, p = l, e = !0) : t >= 1 && p !== u ? (d = 1, p = u, e = !0) : p !== l || r || M(), e) {
                            var o = {
                                    progress: d,
                                    state: p,
                                    scrollDirection: n
                ...
                var M = function(t) {
                        if (O && s) {
                            ...
                            if (t || p !== l) {
                                ...
                                P.pushFollowers ? f.duration > 0 && (p === u && 0 === parseFloat(r.css(P.spacer, "padding-top")) ? o = !0 : p === a && 0 === parseFloat(r.css(P.spacer, "padding-bottom")) && (o = !0)) : n[e.vertical ? "top" : "left"] = f.duration * d, r.css(i, n), o && A()
                            } else {
                                ...
                                c[e.vertical ? "top" : "left"] += h, r.css(P.spacer.firstChild, {
                                    top: c.top,
                                    left: c.left
                                })
                            }
                    ...
                    A = function() {
                        if (O && s && P.inFlow) {
                            ...
                            P.relSize.width || P.relSize.autoFullWidth ? t ? r.css(O, {
                                ...
                                width: "100%"
                            }) : (o["min-width"] = r.get.width(e ? O : i, !0, !0), o.width = t ? o["min-width"] : "auto"), P.relSize.height ? t ? r.css(O, {
                                height: r.get.height(P.spacer) - (P.pushFollowers ? f.duration : 0)
                            }) : r.css(O, {
                                height: "100%"
                            }) : (o["min-height"] = r.get.height(e ? i : O, !0, !n), o.height = t ? o["min-height"] : "auto"), P.pushFollowers && (o["padding" + (e ? "Top" : "Left")] = f.duration * d, o["padding" + (e ? "Bottom" : "Right")] = f.duration * (1 - d)), r.css(P.spacer, o)
                        }
                    },
                    L = function() {
                    ...
                    I = function(t) {
                        s && O && p === l && !s.info("isDocument") && (t.preventDefault(), s._setScrollPos(s.info("scrollPos") - ((t.wheelDelta || t[s.info("vertical") ? "wheelDeltaY" : "wheelDeltaX"]) / 3 || 30 * -t.detail)))
                    };
                this.setPin = function(t, i) {
                    ...
                    if (a || r.extend(f, r.css(O, ["width", "height"])), r.css(c, f), c.setAttribute(e, ""), r.addClass(c, i.spacerClass), P = {
                            spacer: c,
                            relSize: {
                    ...
                    }), window.addEventListener("scroll", L), window.addEventListener("resize", L), window.addEventListener("resize", D), O.addEventListener("mousewheel", I), O.addEventListener("DOMMouseScroll", I), M(), h
                    ...
                    if (O) {
                        if (p === l && M(!0), t || !s) {
                            ...
                            P.spacer.parentNode.insertBefore(i, P.spacer), P.spacer.parentNode.removeChild(P.spacer), O.parentNode.hasAttribute(e) || (r.css(O, O.___origStyle), delete O.___origStyle)
                        }
                        window.removeEventListener("scroll", L), window.removeEventListener("resize", L), window.removeEventListener("resize", D), O.removeEventListener("mousewheel", I), O.removeEventListener("DOMMouseScroll", I), O = void 0
                    }
                    return h
                };
                var R, N = [];
                return h.on("destroy.internal", function(t) {
                    ...
                    return 0 !== i.length && r.type.String(e) ? (N.length > 0 && h.removeClassToggle(), R = e, N = i, h.on("enter.internal_class leave.internal_class", function(t) {
                    ...
                    return t && N.forEach(function(t) {
                        r.removeClass(t, R)
                    }), h.off("start.internal_class end.internal_class"), R = void 0, N = [], h
                }, y(), h
            };
            var n = {
                defaults: {
    ...
    FastClick.prototype.needsClick = function(t) {
        ...
        if (this.cancelNextClick = !1, this.lastClickTime = t.timeStamp, i = this.trackingClickStart, this.trackingClick = !1, this.trackingClickStart = 0, deviceIsIOSWithBadTarget && (o = t.changedTouches[0], s = document.elementFromPoint(o.pageX - window.pageXOffset, o.pageY - window.pageYOffset) || s, s.fastClickScrollParent = this.targetElement.fastClickScrollParent), n = s.tagName.toLowerCase(), "label" === n) {
            if (e = this.findControl(s)) {
                if (this.focus(s), deviceIsAndroid) return !1;
                s = e
            }
        } else if (this.needsFocus(s)) return t.timeStamp - i > 100 || deviceIsIOS && window.top !== window && "input" === n ? (this.targetElement = null, !1) : (this.focus(s), this.sendClick(s, t), deviceIsIOS4 && "select" === n || (this.targetElement = null, t.preventDefault()), !1);
        return !(!deviceIsIOS || deviceIsIOS4 || (r = s.fastClickScrollParent, !r || r.fastClickLastScrollTop === r.scrollTop)) || (this.needsClick(s) || (t.preventDefault(), this.sendClick(s, t)), !1)
    ...
    ! function(t) {
        ...
        var e = t.GreenSockGlobals || t,
            ...
            P = function(t) {
                var e, i, n = E(t.childNodes),
                    r = n.length;
                for (e = 0; r > e; e++) i = n[e], i._isSplit ? P(i) : (e && 3 === i.previousSibling.nodeType ? i.previousSibling.nodeValue += 3 === i.nodeType ? i.nodeValue : i.firstChild.nodeValue : 3 !== i.nodeType && t.insertBefore(i.firstChild, i), t.removeChild(i))
            },
            M = function(t, e, i, n, r, a, u) {
                var c, h, f, p, d, m, g, v, y, _, x, w, T = s(t),
                    b = l(t, "paddingLeft", T),
                    S = -999,
                    E = l(t, "borderBottomWidth", T) + l(t, "borderTopWidth", T),
                    M = l(t, "borderLeftWidth", T) + l(t, "borderRightWidth", T),
                    A = l(t, "paddingTop", T) + l(t, "paddingBottom", T),
                    L = l(t, "paddingLeft", T) + l(t, "paddingRight", T),
                    D = .2 * l(t, "fontSize"),
                    I = l(t, "textAlign", T, !0),
                    R = [],
                    N = [],
                    ...
                    W = r && -1 !== q.indexOf("lines") ? [] : null,
                    B = -1 !== q.indexOf("words"),
                    H = -1 !== q.indexOf("chars"),
                    X = "absolute" === e.position || e.absolute === !0,
                    Y = e.linesClass,
                    U = -1 !== (Y || "").indexOf("++");
                for (W && 1 === t.children.length && t.children[0]._isSplit && (t = t.children[0]), U && (Y = Y.split("++").join("")), h = t.getElementsByTagName("*"), f = h.length, d = [], c = 0; f > c; c++) d[c] = h[c];
                if (W || X)
                    for (c = 0; f > c; c++) p = d[c], m = p.parentNode === t, (m || X || H && !B) && (w = p.offsetTop, W && m && Math.abs(w - S) > D && "BR" !== p.nodeName && (g = [], W.push(g), S = w), X && (p._x = p.offsetLeft, p._y = w, p._w = p.offsetWidth, p._h = p.offsetHeight), W && ((p._isSplit && m || !H && m || B && m || !B && p.parentNode.parentNode === t && !p.parentNode._isSplit) && (g.push(p), p._x -= b, O(p, t, z) && (p._wordEnd = !0)), "BR" === p.nodeName && p.nextSibling && "BR" === p.nextSibling.nodeName && W.push([])));
                for (c = 0; f > c; c++) p = d[c], m = p.parentNode === t, "BR" !== p.nodeName ? (X && (y = p.style, B || m || (p._x += p.parentNode._x, p._y += p.parentNode._y), y.left = p._x + "px", y.top = p._y + "px", y.position = "absolute", y.display = "block", y.width = p._w + 1 + "px", y.height = p._h + "px"), !B && H ? p._isSplit ? (p._next = p.nextSibling, p.parentNode.appendChild(p)) : p.parentNode._isSplit ? (p._parent = p.parentNode, !p.previousSibling && p.firstChild && (p.firstChild._isFirst = !0), p._next = p.nextSibling && p.nextSibling._isFirst ? null : p.nextSibling, p.parentNode.removeChild(p), d.splice(c--, 1), f--) : m || (w = !p.nextSibling && O(p.parentNode, t, z), p.parentNode._parent && p.parentNode._parent.appendChild(p), w && p.parentNode.appendChild(o.createTextNode(" ")), e.span && (p.style.display = "inline"), R.push(p)) : p.parentNode._isSplit && !p._isSplit && "" !== p.innerHTML ? N.push(p) : H && !p._isSplit && (e.span && (p.style.display = "inline"), R.push(p))) : W || X ? (t.removeChild(p), d.splice(c--, 1), f--) : B || t.appendChild(p);
                if (W) {
                    for (X && (_ = o.createElement(j), t.appendChild(_), x = _.offsetWidth + "px", w = _.offsetParent === t ? 0 : t.offsetLeft, t.removeChild(_)), y = t.style.cssText, t.style.cssText = "display:none;"; t.firstChild;) t.removeChild(t.firstChild);
                    for (v = " " === z && (!X || !B && !H), c = 0; c < W.length; c++) {
                        for (g = W[c], _ = o.createElement(j), _.style.cssText = "display:block;text-align:" + I + ";position:" + (X ? "absolute;" : "relative;"), Y && (_.className = Y + (U ? c + 1 : "")), F.push(_), f = g.length, h = 0; f > h; h++) "BR" !== g[h].nodeName && (p = g[h], _.appendChild(p), v && p._wordEnd && _.appendChild(o.createTextNode(" ")), X && (0 === h && (_.style.top = p._y + "px", _.style.left = b + w + "px"), p.style.top = "0px", w && (p.style.left = p._x - w + "px")));
                        0 === f ? _.innerHTML = "&nbsp;" : B || H || (P(_), C(_, String.fromCharCode(160), " ")), X && (_.style.width = x, _.style.height = p._h + "px"), t.appendChild(_)
                    }
                    t.style.cssText = y
                }
                X && (u > t.clientHeight && (t.style.height = u - A + "px", t.clientHeight < u && (t.style.height = u + E + "px")), a > t.clientWidth && (t.style.width = a - L + "px", t.clientWidth < a && (t.style.width = a + M + "px"))), k(i, R), k(n, N), k(r, F)
            },
            A = function(t, e, i, n) {
                var s, a, l, u, c, m, w, T, b, S = e.span ? "span" : "div",
                    k = e.type || e.split || "chars,words,lines",
                    E = (-1 !== k.indexOf("words"), -1 !== k.indexOf("chars")),
                    ...
                    I = t.parentNode;
                for (I.insertBefore(D, t), D.textContent = t.nodeValue, I.removeChild(t), t = D, s = r(t), w = -1 !== s.indexOf("<"), e.reduceWhiteSpace !== !1 && (s = s.replace(f, " ").replace(h, "")), w && (s = s.split("<").join("{{LT}}")), c = s.length, a = (" " === s.charAt(0) ? M : "") + i(), l = 0; c > l; l++)
                    if (m = s.charAt(l), m === P && s.charAt(l - 1) !== P && l) {
                        for (a += L ? A : "", L = !1; s.charAt(l + 1) === P;) a += M, l++;
                        l === c - 1 ? a += M : ")" !== s.charAt(l + 1) && (a += M + i(), L = !0)
                    } else "{" === m && "{{LT}}" === s.substr(l, 6) ? (a += E ? n() + "{{LT}}</" + S + ">" : "{{LT}}", l += 5) : m.charCodeAt(0) >= p && m.charCodeAt(0) <= d || s.charCodeAt(l + 1) >= 65024 && s.charCodeAt(l + 1) <= 65039 ? (T = x(s.substr(l, 2)), b = x(s.substr(l + 2, 2)), u = T >= g && v >= T && b >= g && v >= b || b >= y && _ >= b ? 4 : 2, a += E && " " !== m ? n() + s.substr(l, u) + "</" + S + ">" : s.substr(l, u), l += u - 1) : a += E && " " !== m ? n() + m + "</" + S + ">" : m;
                t.outerHTML = a + (L ? A : ""), w && C(I, "{{LT}}", "<")
            },
            L = function(t, e, i, n) {
                var r, o, s = E(t.childNodes),
                    a = s.length,
                    u = "absolute" === e.position || e.absolute === !0;
                if (3 !== t.nodeType || a > 1) {
                    for (e.absolute = !1, r = 0; a > r; r++) o = s[r], (3 !== o.nodeType || /\S+/.test(o.nodeValue)) && (u && 3 !== o.nodeType && "inline" === l(o, "display", null, !0) && (o.style.display = "inline-block", o.style.position = "relative"), o._isSplit = !0, L(o, e, i, n));
        ...
        D.split = function(t) {
            ...
            for (var e, i, n, r = this.elements.length, o = t.span ? "span" : "div", s = ("absolute" === t.position || t.absolute === !0, b(t.wordsClass, o)), a = b(t.charsClass, o); --r > -1;) n = this.elements[r], this._originals[r] = n.innerHTML, e = n.clientHeight, i = n.clientWidth, L(n, t, s, a), M(n, t, this.chars, this.words, this.lines, i, e);
    ...
    function(t) {
        ...
        n.prototype.options = {
            ...
            this._removeFocus(), this._isOpen() ? (this.current !== -1 && (this.selPlaceholder.textContent = this.selOpts[this.current].textContent, jQuery("#category-buttons").find("." + this.selPlaceholder.textContent.cleanup()).trigger("click"), jQuery("#category-tattoos-buttons").find("." + this.selPlaceholder.textContent.cleanup()).trigger("click"), jQuery("#year-buttons").find("." + this.selPlaceholder.textContent.cleanup()).trigger("click"), jQuery("#artist-buttons").find("." + this.selPlaceholder.textContent.cleanup()).trigger("click")), classie.remove(this.selEl, "cs-active")) : (this.hasDefaultPlaceholder && this.options.stickyPlaceholder && (this.selPlaceholder.textContent = this.selectedOpt.textContent), classie.add(this.selEl, "cs-active")), String.prototype.cleanup = function() {
     ...
     window.onload = function() {
            ...
            function e() {
                $(document).on("click", "a", function(e) {
                    if ("#" === $(this).attr("href") || $(this).hasClass("no-event")) e.preventDefault();
                    else if ("_blank" === $(this).attr("target")) window.open($(this).attr("href"), "_blank");
                    else {
                        e.preventDefault();
            ...
            function r() {
                $(".hamburger").unbind("click").bind("click", function(t) {
                    $(".hamburger").toggleClass("is-active"), p.reversed() ? p.play() : p.reverse()
                })
            }
            ...
            var s = !!window.opr && !!opr.addons || !!window.opera || navigator.userAgent.indexOf(" OPR/") >= 0,
                ...
                f = (h || s) && !!window.CSS;
            s ? $("html").addClass("browser-opera") : a ? $("html").addClass("browser-firefox") : l ? $("html").addClass("browser-safari") : u ? $("html").addClass("browser-ie") : c ? $("html").addClass("browser-edge") : h ? $("html").addClass("browser-chrome") : f && $("html").addClass("is-blink"), $(".filter-bar-container").length > 0 && ($(".filter-bar-container").sticky({
                topSpacing: 0,
            ...
            })), $(".news-content, .fix-markup").find("p").addClass("center-text"), $("body").hasClass("single-post") && $(".nav-animation").find(".reveal-news").parent().addClass("selected"), $("body").hasClass("single-tattoos_post-type") && $(".nav-animation").find(".reveal-tattoo").parent().addClass("selected");
            ...
            $(t).submit(function(i) {
                ...
                $.ajax({
                    ...
                    $(e).removeClass("error"), $(e).addClass("success"), $(e).text(t)
                }).fail(function(t) {
